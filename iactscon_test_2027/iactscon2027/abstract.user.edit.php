                         ...
                         <?php
                            ...
                            <div class="form_grid">
                                 <div class="frm_grp span_0 span_2">
                                    ...
                                    <input type="email"  name="abstract_coauthor_edit_email[]"  id="abstract_coauthor_edit_email"  value="<?= $rowFetchcoAuthorDetails['abstract_coauthor_email'] ?>"   validate="Please Enter Email Address" required>
                                </div>
                                 <div class="frm_grp span_0 span_2">
                                    <p class="frm-head">Mobile Number <i class="mandatory">*</i></p>
                                    <div class="sub_frm_grp form_grid">
                                        <input type="text" value="+91" name="abstract_coauthor_edit_phone_code[]" value="<?= $rowFetchcoAuthorDetails['abstract_coauthor_phone_code'] ?>" required validate="Please Enter Mobile Prefix">
                                        <input class="span_3" validate="Please Enter Mobile Number"  required  name="abstract_coauthor_edit_phone_no[]" id="abstract_coauthor_edit_phone_no<?= $rowFetchcoAuthorDetails['id'] ?>"  onkeypress="return isNumber(event)"  maxlength="10"  value="<?= $rowFetchcoAuthorDetails['abstract_coauthor_phone_no'] ?>">
                                    </div>
                                </div>
                                <div class="frm_grp span_1">
                                    <p class="frm-head">Title <i class="mandatory">*</i></p>
                                ...
                                <div class="frm_grp span_3">
                                    <p class="frm-head">First Name <i class="mandatory">*</i></p>
                                    <input placeholder="Enter First Name"  value="<?= $rowFetchcoAuthorDetails['abstract_coauthor_first_name'] ?>"   required name="abstract_coauthor_edit_first_name[]" id="abstract_coauthor_first_name" validate="Please Enter First Name" >
                                </div>
                                <div class="frm_grp span_2">
                                    <p class="frm-head">Middle Name</p>
                                ...
                                <div class="frm_grp span_2">
                                    <p class="frm-head">Last Name <i class="mandatory">*</i></p>
                                    <input required placeholder="Last Name"  value="<?= $rowFetchcoAuthorDetails['abstract_coauthor_last_name'] ?>"  name="abstract_coauthor_edit_last_name[]" id="abstract_coauthor_last_name"  validate="Please Enter Last Name">
                                </div>
                                <div class="frm_grp span_4">
                                    <p class="frm-head">Address <i class="mandatory">*</i></p>
                                    <input name="abstract_coauthor_edit_address[]" id="abstract_coauthor_address"   value="<?= $rowFetchcoAuthorDetails['abstract_coauthor_address'] ?>" validate="Please Enter Your Address" type="text" required>
                                </div>
                                <div class="frm_grp span_2">
                                    <p class="frm-head">Country <i class="mandatory">*</i></p>
                                      <select class=" <?= $disabledclass ?>"
                            ...
                            <div class="form_grid" id="fields_area">
                               ...
                               <?php
                                function cleanFields($fields){
                                    ...
                                    <div class="frm_grp span_4 upload-section-cat" id="upload_section-cat_<?= $category['id'] ?>">
                                        ...
                                        <div class="file-up-dtls">
                                            ...
                                            <input class="form-control category-file" 
                                                ...
                                                <?= $existingCategoryFile != '' ? 'style="display:none;"' : '' ?> />
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <?php
                                    // HOD CONSENT FILE
                                    if ($hod_consent_file_types !== 'null' && file_exists(_BASE_URL_ . $cfg['FILES.ABSTRACT.REQUEST']. $rowAbstractDetails['abstract_consent_file'])):
                                    ...
                                    <div class="frm_grp span_4">
                                        ...
                                        <div class="file-up-dtls">
                                            ...
                                            <input class="form-control consent-file" 
                                                ...
                                                <?= $existingHodFile != '' ? 'style="display:none;"' : '' ?> />
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="frm_grp span_4">
                                        ...
                                        <div class="file-up-dtls">
                                            ...
                                            <input class="form-control abstract-file" 
                                                ...
                                                <?= $existingAbstractFile != '' ? 'style="display:none;"' : '' ?> />
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                   ...
                                   if ($resultAbstractSubcat[0]['related_subcategoryId']!=''){
                                        ...
                                        $sqlAbstractSubcat['PARAM'][]   = array('FILD' => 'related_category_id',  'DATA' => $rowAbstractDetails['abstract_cat'],  'TYP' => 's');
								     	$sqlAbstractSubcat['PARAM'][]   = array('FILD' => 'related_subcategoryId',  'DATA' =>$rowAbstractDetails['abstract_parent_type'],  'TYP' => 's');
                                ...
                                <li>
                                    ...
                                    <div class="form_grid" id="fields_area1">
                                        ...
                                        <div class="frm_grp span_4">
                                          ...
                                          <? } ?>
                                        <div class="frm_grp span_4">
                                            <p class="frm-head">Abstract_title</p>
									...
									if ($rowAbstractDetails[$value['field_key']] != '' && $rowAbstractDetails[$value['field_key']] != NULL && $rowAbstractDetails[$value['field_key']] != 'NULL') {
                                        ...
                                        <div class="frm_grp span_4" id="review_abstract_wrapper" style="display:none;">
                                            <p class="frm-head">Abstract File(If any Illustration/Diagram/Picture)</p>
                                        ...
                                        <div class="frm_grp span_4" id="review_hod_wrapper" style="display:none;">
                                            <p class="frm-head">HOD Consent File(Only appilicable for trainee/PGT)</p>
...
<script>
    ...
    function populateCoAuthorsReview() {
       ...
       let reviewCounter = 1; // counter for only valid co-authors
        ...
        $(".registration_right_body_content_author, .coauthor_wrap .coauthor_item").each(function(index) {
            var coauthor = $(this);
            var nameVal = coauthor.find("[name='abstract_coauthor_edit_email[]']").val();
            ...
            var reviewItem = `<li class="coauthor_review_item">
                ...
                <div class="form_grid">
                    ...
                    <div class="frm_grp span_2"><p class="frm-head">Address</p><h6>
                     ...
                     <div class="frm_grp span_2"><p class="frm-head">Country</p><h6>
                        ${coauthor.find("[name='abstract_coauthor_edit_country[]'] option:selected").text() || '-'}, 
                
                    </h6></div>
                     <div class="frm_grp span_2"><p class="frm-head">State</p><h6>
                       
                        ${coauthor.find("[name='abstract_coauthor_edit_state[]'] option:selected").text() || '-'}, 
   ...
   function checkAbstractLimits() {
    ...
    // If no body textareas exist on current page, consider it valid
    ...
    // Calculate total count from all textareas in the abstractContent group
    ...
    if (total > bodyLimit) {
        ...
        // Scroll to the abstract body counter
        if ($("#abstract_body_count").length) {
            $('html, body').animate({
        ...
        <li class="coauthor_item">
          <div class="form_grid">
                ...
                <div class="frm_grp span_0 span_2">
                    ...
                    <input type="email"  name="abstract_coauthor_edit_email[]"    validate="Please Enter Email Address" required>
                </div>
                 <div class="frm_grp span_0 span_2">
                    <p class="frm-head">Mobile Number <i class="mandatory">*</i></p>
                    <div class="sub_frm_grp form_grid">
                        <input type="text" value="+91" name="abstract_coauthor_edit_phone_code[]" value="" required validate="Please Enter Mobile Prefix">
                        <input class="span_3" validate="Please Enter Mobile Number"  required  name="abstract_coauthor_edit_phone_no[]" onkeypress="return isNumber(event)"  maxlength="10"  value="">
                    </div>
                </div>
                <div class="frm_grp span_1">
                    <p class="frm-head">Title <i class="mandatory">*</i></p>
                ...
                <div class="frm_grp span_3">
                    <p class="frm-head">First Name <i class="mandatory">*</i></p>
                    <input placeholder="Enter First Name"   required name="abstract_coauthor_edit_first_name[]" id="abstract_coauthor_first_name" validate="Please Enter First Name" >
                </div>
                <div class="frm_grp span_2">
                    <p class="frm-head">Middle Name</p>
                ...
                <div class="frm_grp span_2">
                    <p class="frm-head">Last Name <i class="mandatory">*</i></p>
                    <input required placeholder="Last Name"  name="abstract_coauthor_edit_last_name[]" id="abstract_coauthor_last_name"  validate="Please Enter Last Name">
                </div>
                <div class="frm_grp span_4">
                    <p class="frm-head">Address <i class="mandatory">*</i></p>
                    <input name="abstract_coauthor_edit_address[]" id="abstract_coauthor_address"  validate="Please Enter Your Address" type="text" required>
                </div>
                <div class="frm_grp span_2">
                    <p class="frm-head">Country <i class="mandatory">*</i></p>
                ...
                <div class="frm_grp span_2">
                    <p class="frm-head">City <i class="mandatory">*</i></p>
                    <input type="text" name="abstract_coauthor_edit_city[]" required class="form-control" style="text-transform:uppercase;" />
                </div>
                <div class="frm_grp span_2">
                    <p class="frm-head">Pin <i class="mandatory">*</i></p>
                ...
                <div class="frm_grp span_2">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <input type="text" name="abstract_coauthor_institute_edit_name[]" class="form-control" required />
                ...
                <div class="frm_grp span_2">
                    ...
                    <input type="text" name="abstract_coauthor_edit_department[]" class="form-control" required />
...
$(document).ready(function(){
 ...
 $('#formFileAbstract').on('change', function() {
           ...
           $(document).on('change', '.award-toggle', function () {
            ...
            if ($(this).is(':checked')) {
                 fileInput.attr('required', false);   // make required
