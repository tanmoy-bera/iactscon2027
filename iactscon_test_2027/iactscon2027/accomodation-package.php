...
<body class="single inner-page">
  ...
  $comboWorkshopDetailsArray = getAllComboWorkshopList();
  ...
  ?>
  <form class="body-frm" name="registrationForm" action="<?= _BASE_URL_ ?>combo.registration.process.php" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="combo_classification_id" id="combo_classification_id" value="" />
    <input type="hidden" name="isCombo" id="isCombo" value="Y" />
    <input type="hidden" name="accommodation_date_id" id="accommodation_date_id" value="" />
    ...
    <input type="hidden" name="total_section" id="total_section" value="" />
    ...
    <main>
          ...
          <div class="inner-greadient-sec">
            <div class="row">
              ...
              <div class="col-lg-6 carvslider-holder bdrRight">
                <div class="cart disabled-click" id="cart">
                  <img src="<?= _BASE_URL_ ?>images/cart.png" alt="">
                </div>
                <div class="smobilexx accm-pack-for drama-total-holder" id="section7">
                  <?php
                  ...
                  ?>
                      <div>
                        ...
                        <div class="vanue-image aos-init aos-animate"><img src="<?= $hotel_background_image ?>" alt=""></div>
                        <div class="vanue-form">
                          <div class="pxl-item--content">
                            ...
                            <h3 class="pxl-item--title"><?= $val['hotel_name'] ?></h3>
                            <div class="pxl-item--desc"><i class="far fa-map-marker-alt"></i><?= nl2br($val['hotel_address']) ?></div>
                            <div class="pxl-item--desc"><i class="fal fa-utensils"></i> Breakfast Included</div>
                            <?php
                            $sqlAcc = array();
                            $sqlAcc['QUERY']    = "SELECT * FROM " . _DB_ACCOMMODATION_ACCESSORIES_ . "  WHERE `hotel_id` = '" . $val['id'] . "' AND status='A' AND purpose='aminity'";

                            $queryAcc = $mycms->sql_select($sqlAcc, false);
                            if ($queryAcc) {
                            ?>
                              <div class="aminity-box">
                                <?php
                                foreach ($queryAcc as $key => $aminity) {
                            ...
                            <div class="pxl-item--button">
                              <a href="#" class="button-40 bookHotel" onclick="getAccommodationDetails('<?= $val['id'] ?>')" id="bookHotel" hotelId="<?= $val['id'] ?> ">Book Now</a>
                ...
                <div class="smobilexx accm-pack-nav">
                  <?php
                  ...
                  ?>
                    <div>
                      <img class="accm-img" src="<?= $hotel_image ?>">
                    </div>
                  <?php } ?>
              ...
              <div class="col-lg-6 right-slider d-none">
                <?php
              ...
              <div class="col-lg-6 right-slider pac-right-slider">
                <div class="pd-row section" id="section1">
                  <div class="pac-header">
                    <h4>Residential<br>Package</h4>
                    <div>
                      <h6>Inclusions</h6>
                      <div class="pac-head-rt">
                        <p>
                          <img src="<?= _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE']; ?><?= $resultIcon[0]['icon'] ?>" alt="" />
                          Registration
                        </p>
                        <?php
                        foreach ($resultIcon as $k => $val) {
                          if ($val['title'] == 'Workshop' && !empty($resultWorkshop)) { ?>
                            <p>
                              <img src="<?= _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE']; ?><?= $val['icon'] ?>" alt="" />
                              Workshop
                            </p>
                          ...
                          if ($val['title'] == 'Banquet' && !empty($resultDinner)) { ?>
                            <p>
                              <img src="<?= _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE']; ?><?= $val['icon'] ?>" alt="" />
                              Banquet
                            </p>
                          ...
                          if ($val['title'] == 'Accommodation' && !empty($resultAccommodation)) { ?>
                            <p>
                              <img src="<?= _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE']; ?><?= $val['icon'] ?>" alt="" />
                              Accommodation
                            </p>
                  ...
                  <div class="pac-body blur_bw" id="hotelPackageList">
                    <p class="pac-p">Make your Selection</p>
                    <div class="pac-div" id="hotelPackageLists">
                      <!-- ajax -->
                    </div>
                  </div>
                </div>
                <div class="pd-row section" use="registrationUserDetails" id="section2">
                  ...
                  <div class="lftinrminH">
                    <div class="row">
                      ...
                      <div class="col-lg-12 form mb-3 select-title <?= $blurclass ?>">
                        <div class="d-flex">
                          ...
                          <select name="user_initial_title" class="col-lg-2 <?= $disabledclass ?>" <?= $disabled ?>>
                      ...
                      if (in_array("Gender", $available_registration_fields)) {
                      ?>
                        <div class="col-lg-6 mb-3 d-flex align-items-center <?= $blurclass ?>" id="radioGender">
                          <label>Gender: </label>
                          <label class="custom-radio"> Male <input type="radio" groupname="user_gender" name="user_gender" id="user_gender_male" value="Male" <?= $disabled ?> required=""><span class="checkmark"></span></label>

                          <label class="custom-radio">Female <input type="radio" groupname="user_gender" name="user_gender" id="user_gender_female" value="Female" <?= $disabled ?> required><span class="checkmark"></span> </label>
                        </div>
                    ...
                    <div class="row align-items-center">
                      <div class="col-lg-12 mb-3 total-price">
                        <h6>TOTAL</h6>
                        <hr>
                        <strong>&#8377; <span id="confPrc"></span></strong>
                      </div>
                    </div>
                  ...
                  <div class="next-prev-btn-box ">
                    ...
                    <a class="btn next-btn prev" id="prevBtn" title="<?= $cfg['CATEGORY_TITLE'] ?>">Prev</a>
                    <a class="btn next-btn btn-w next open-checkout-modal" id="user_details" workshop-count="<?= count($comboWorkshopDetailsArray) ?>" accompany-count="<?= $accompanyCount ?>" accommodation-count="<?= $countAcc ?>" title="<?= $cfg['WORKSHOP_TITLE'] ?>">Next
                    </a>
                  </div>
                </div>
                <div class="category-table-rowxx drama-total-holder  section" id="section3">
                  <div class="lftinrminH-holder">
                    ...
                    $workshoDefinedDate = '';
                    // foreach ($workshopDetailsArray as $keyComboclsf => $rowWorkshopclsf) {
                    ...
                    if ($comboWorkshopDetailsArray) {
                    ?>
                      <div class="lftinrminH">
                        <?php

                        $loopcount = 0;
                        foreach ($comboWorkshopDetailsArray as $keyComboclsf => $rowWorkshopclsf) {

                          foreach ($rowWorkshopclsf as $keyRegClasf => $rowRegClasf) {

                            $workshopCount = getWorkshopClassificationSeatLimit($rowRegClasf['id']);
                            ...
                            $displayName = '';
                            $len     = strlen($rowRegClasf['classification_title']);
                            if ($len > 40) {
                              $charCount = 0;
                              $lines = array();
                              $words = explode(' ', $rowRegClasf['classification_title']);
                              ...
                              $displayName = $rowRegClasf['classification_title'];
                            }
                        ...
                        ?>
                            ...
                            <div class="accompany-row " use="<?= $keyComboclsf ?>" operetionMode="workshopTariffTr" style="display:none;" operetionDisplay="workshopDisplay<?= $rowRegClasf['id'] ?>" class="workCombo">
                              <div class="custom-checkbox accompanying ">
                                <input type="radio" name="workshop_id[]" id="workshop_id_<?= $keyComboclsf . '_' . $keyRegClasf ?>" value="<?= $rowRegClasf['id'] ?>" <?= $style ?> workshopName="<?= $rowRegClasf['classification_title'] ?>" operationMode="workshopId" amount='0' invoiceTitle="Workshop - <?= $rowRegClasf['classification_title'] ?>" workshopCount="<?= $workshopCount ?>" icon="<?= $workshopIcon ?>" reg="workshop">
                                <label for="workshop_id_<?= $keyComboclsf . '_' . $keyRegClasf ?>">
                                  <div class="por-row">
                                    <div class="por-lt">
                                      <div class="por-inner">
                                        <h3><?= $displayName ?></h3>
                                      ...
                                      <div class="por-location">
                                        <ul>
                                          <li><a href="javascript:void(0)" target="_blank"><img src="<?= _BASE_URL_ ?>images/loction.png" alt="" /> <?= $rowRegClasf['venue'] ?></a>
                                          </li>
                                        </ul>
                                      </div>
                                      <div class="por-date">
                ...
                <div class="category-table-rowxx drama-total-holder section" id="section4">
                  <div class="lftinrminH-holder">
                    ...
                    ?>
                      <div class="lftinrminH">
                        ...
                        <button class="pay-button" id="add-accompany-btn">Add More</button>
                        <!-- </form> -->
                  ...
                  <div class="bottom-fx">
                    ...
                    <div class="next-prev-btn-box">
                      ...
                      <a class="btn next-btn prev" title="<?= $cfg['WORKSHOP_TITLE'] ?>" workshop-count="<?= count($workshopDetailsArray) ?>" accompany-count="<?= $accompanyCount ?>">Prev</a>
                ...
                <div class="category-table-rowxx drama-total-holder section add-inclusion" id="section5">
                  ...
                  if (count($dinnerTariffArray) > 0) {
                    ...
                    // echo '<pre>'; print_r($dinnerTariffArray);echo '</pre>';    
                  ?>
                          ...
                          <div class="gala-inner-lt">
                            ...
                            foreach ($dinnerTariffArray as $keyDinner => $dinnerValue) { ?>
                              <div class="gala-location">
                                <ul>
                                  <li><a href="<?= $dinnerValue[$currentCutoffId]['link'] ?>" target="_blank"><img src="<?= _BASE_URL_ ?>images/loction.png" alt="" /> <?= $dinnerValue[$currentCutoffId]['dinner_hotel_name'] ?></a></li>
                                  <li><img src="<?= _BASE_URL_ ?>images/calender.png" alt="" /> <?= date('d/m/Y', strtotime($dinnerValue[$currentCutoffId]['DATE'])) ?></li>
                                </ul>
                              </div>
                          </div>
      ...
      <!--  style="filter: blur(1.6px);width: 40%;" -->
  ...
  <script>
    ...
    $('.accm-pack-nav').slick({
      ...
      onAfterChange: function(slide, index) {
        console.log("accm-pack-nav change");
  ...
  <script>
    $(document).ready(function() {
      $('.pac-clk').click(function() {
        if ($(this).hasClass("active")) {
          $(".pac-box").slideUp();
          $(".pac-clk").removeClass("active");
        } else {
          $(".pac-box").slideUp();
          $(".pac-clk").removeClass("active");
          $(this).parent().find(".pac-box").slideToggle();
          $(this).parent().find(".pac-clk").toggleClass("active");
        }
      });
    ...
    function confirmComboHotelBooking(comboTariffId) {
      // alert(comboTariffId);
      $('#combo_classification_id').val(comboTariffId);
      var flag = 0;

      var isCheckedPackageType = $('#package_type_check_' + comboTariffId + ' input[name="package_type"]:checked').length;
      // var packageType = isCheckedPackageType.val();
      var packageType = $('#package_type_check_' + comboTariffId + ' input[name="package_type"]:checked').val();
      // alert(packageType)

      var isCheckedDates = $('#checkin_checkout_date_id' + comboTariffId + ' option:selected');
      var checkin_checkout_date_id = isCheckedDates.val();
      $('#accommodation_date_id').val(checkin_checkout_date_id);


      if (isCheckedPackageType == 0) {
        flag++;
        toastr.error("Please select room type", 'Error', {
          "progressBar": true,
      ...
      if (flag == 0) {
        currentSection = 2;
        total_section = 3;
        $('#section3 input[type="checkbox"], #section3 input[type="radio"]').prop('checked', false);
        $('#section4 input[type="checkbox"], #section4 input[type="radio"]').prop('checked', false);
        $('#section5 input[type="checkbox"], #section5 input[type="radio"]').prop('checked', false);
        // $("input[type=radio][operationMode=workshopTariffTr]").prop("checked",false);
        $("div[operationMode=workshopTariffTr]").css('display', 'none');
        calculateTotalAmount(comboTariffId);
        // alloteSection(comboTariffId);
        $.ajax({
          type: "POST",
          url: jsBASE_URL + 'combo.registration.process.php',
          data: 'act=allotComboSection&combo_id=' + comboTariffId,
          dataType: 'json',
          async: false,
          success: function(JSONObject) {
            ...
            if (Number(JSONObject.WORKSHOP_PRICE) > 0) {
              total_section++;
              $(".next").attr('workshop-count', 1);
              $(".prev").attr('workshop-count', 1);
              $(".skip").attr('workshop-count', 1);
            } else {
              $(".next").attr('workshop-count', 0);
              $(".prev").attr('workshop-count', 0);
              $(".skip").attr('workshop-count', 0);
            }
            if (JSONObject.DINNER_PRICE > 0) {

              $(".next").attr('banquet-count', 0);
              $(".prev").attr('banquet-count', 0);
              $(".skip").attr('banquet-count', 0);
            } else {
              total_section++;
              $(".next").attr('banquet-count', 1);
              $(".prev").attr('banquet-count', 1);
              $(".skip").attr('banquet-count', 1);
            }
        ...
        $('.bookHotel').addClass('disabled-click');
        showSection(2);
      }



      $("div[operetionMode=workshopTariffTr][use=" + comboTariffId + "]").find('input[type="radio"]').each(function() {
    ...
    $(document).on('click', '.checkboxClassDinner', function() {
    ...
    // })
    var regClsfId = $('#combo_classification_id').val();
    ...
    $('#prevBtn').on('click', function() {
      ...
      if (currentSection > 1) {
        ...
        currentSection--;
        if (currentSection == 1) {
          $('.bookHotel').removeClass('disabled-click');
          $('#cart').addClass('disabled-click');
        }
        showSection(currentSection);
      }
    ...
    $(document).on('change', 'input[type="checkbox"][name="accompanyCount"]', function() {
      if (!$(this).is(':checked')) {

        // Get the decrementCount from the associated checkbox


        $('#gala-dinner-select1').hide();
      } else {
        $('#gala-dinner-select1').show();
      }
    });
    ...
    $('.next').click(function() {
      ...
      if (validateSection(currentSection)) {
        ...
        totalSec = $('#total_section').val();
        // alert(currentSection+", tot= "+totalSec)
        // totalSec = 5;
        if (currentSection == totalSec || currentSection > totalSec) {
          showSection(currentSection);
          $('#checkout-main-wrap').show();
          return;
        }
        ...
        if (currentSection < $('.section').length) {
          ...
          if (workshop_count == 0) {
            ...
            if ($('input[name="package_type"]:checked').val() == 'shared') {
              currentSection--;
              currentSection--;
              $('#checkout-main-wrap').show();
              return false;
            ...
            var regClsfId = $('#combo_classification_id').val();
            // $("input[type=radio][operationMode=workshopTariffTr]").prop("checked",false);
            // $("div[operationMode=workshopTariffTr]").hide();
            $("div[operetionMode=workshopTariffTr][use=" + regClsfId + "]").show();
          ...
          } else if (accompany_count == 0 || $('input[name="package_type"]:checked').val() == 'shared') {
    ...
    $('.skip').click(function() {
      ...
      if (currentSection == 4) {
        ...
        $('.delete-accompany-btn[reg="dinnerAccompany"]').each(function() {

          $(this).closest('tr').remove();

        });
        $('input[type="checkbox"][reg="dinnerAccompany"]').prop('checked', false);
        $('#gala-dinner-select1').hide();
    ...
    $("input[type=checkbox][use=dinner]").click(function() {
      var count = parseInt($(this).val());
    ...
    function validateSection(section) {
      ...
      $("#section" + section + " input[type='text'], #section" + section + " input[type='radio'], #section" + section + " input[type='checkbox'], #section" + section + " select").each(function(index) {
        ...
        if ($(this).attr('type') === 'text' && !$.trim($(this).val())) {
        ...
        } else if ($("input[type='checkbox'][name='accompanyCount']:checked").length == 0 && section == 4) {
          ...
          //alert(countindex);
          var isAccompany = $("input[type='checkbox'][name='accompanyCount']:checked").length;
          if (isAccompany > 0) {
            galaDinnerDiv += '<div class="gala-row"><div class="d-flex align-items-center"><div class="gala-inner-lt"><div class="gala-inner"><div class="gala-box"><img src="<?= _BASE_URL_ ?>images/gala-logo.png" alt="" class="gold-img" /></div><div class="gala-name"><h5 id="dinner_name">' + $(this).val() + '</h5></div></div><div class="gala-location"><ul><li><a  href="' + dinner_hotel_link + '" target="_blank"><img src="<?= _BASE_URL_ ?>images/loction.png" alt="" /> ' + dinner_hotel_name + '</a></li><li><img src="<?= _BASE_URL_ ?>images/calender.png" alt="" /> ' + dinner_date + '</li></ul></div></div><div class="gala-inner-rt"><div class="gala-main"><div class="acc-gala-price">' + dinner_amnt_display + '</div></div></div></div><div class="select-dinner d-flex align-items-center"><div class="custom-checkbox"><input type="checkbox" name="accompany_dinner_value[' + decrementCount + ']" accDinnerCount="' + decrementCount + '" id="dinner_value' + decrementCount + '" value="' + dinner_classification_id + '" operationMode="dinner" use="dinner" reg="dinnerAccompany" amount="' + dinner_amnt + '" invoiceTitle="' + dinner_title + '-Accompany' + countindex + '" icon="images/ac4.png" class="checkboxClassDinner" qty=' + countQty + '><label for="dinner_value' + decrementCount + '" >Please choose Now</label></div> </div></div>';
          }
          isGalaFlag = true;
    ...
    $(document).on("click", "#deleteItem", function() {
      ...
      if (reg === 'accompany') {
        ...
        $(this).closest('tr').remove();
        // $('#deleteItem[reg="dinnerAccompany"]').trigger('click');
        $('.delete-accompany-btn[reg="dinnerAccompany"]').each(function() {
      ...
      if (reg === 'dinner') {
        //  var  accDinner=$(this).attr('accDinnerCount');
        //  alert(accDinner)
        //   if(accDinner != undefined || accDinner != ''){
        //     $('#dinner_value'+accDinner).prop('checked', false);
        //     $(this).closest('tr').remove();
        //     calculateTotalAmount();
        //   }
        //   else{

        $('#dinner_value').prop('checked', false);
        $(this).closest('tr').remove();
        calculateTotalAmount();
        // }
      }
      if (reg === 'dinnerAccompany') {
        var accDinner = $(this).attr('accDinnerCount');
    ...
    // function calculateTotalAmount1(comboTariffId = "") {
    ...
    //   var element = $('#package_type_check_' + comboTariffId);
    ...
    //     var attr = $(element).attr('amountShared');
    //   } else {
    //     var attr = $(element).attr('amountIndividual');
    //   }
    //   // alert(attr);



    //   var operation = $(element).attr('operationmodetype');
    //   var regtype = $(element).attr('regtype');
    //   var reg = $(element).attr('reg');
    //   var accdinnercount = $(element).attr('accdinnercount');
    ...
    //     var attrReg = $(element).attr('operationMode');
    ...
    //       var imageElement = $('<img>').attr('src', "<?= _BASE_URL_ ?>" + $(element).attr('icon'));
    //       //alert("<?= _BASE_URL_ ?>"+$(this).attr('icon'));
    //       $(cloned).find("span[use=icon]").append(imageElement);
    //       $(cloned).find("span[use=invTitle]").append($(element).attr('invoiceTitle') + " - " + packageType);
    //       if (regtype === 'combo') {
    ...
    //             .attr('reg', reg)
    //             .attr('accdinnercount', accdinnercount)
    ...
    function calculateTotalAmount_X(comboTariffId = "") {
      console.log("====calculateTotalAmount====");
      ...
      $('input[type=checkbox]:checked,input[type=radio]:checked,#accomodation_package_checkout_id option,#accommodation_room option').each(function() {
        ...
        var accdinnercount = $(this).attr('accdinnercount');
        console.log('Qty=' + qty);
        var hasTotalAmntFlag = false;
        ...
        if (typeof attr !== typeof undefined && attr !== false) {
          ...
          if (regtype !== 'combo') {
            ...
            if (reg != undefined && (reg == 'dinner' || reg == 'dinnerAccompany') && qty != undefined) {
    ...
    $(document).ready(function() {
      ...
      function addAccompany() {
        ...
        $("#cloneIntro_" + fieldSerializeCount + " label:before").css('border', '0px solid black');
    ...
    function getAccommodationDetails(hotel_id) {
      ...
      // alert(hotel_id);
      $("#hotelPackageList").removeClass('blur_bw');
      if (hotel_id > 0) {
        //alert(jsBASE_URL); + '&abstractDelegateId=' + abstractDelegateId
        // var abstractDelegateId = $( '#abstractDelegateId').val()
        $.ajax({
          type: "POST",
          url: jsBASE_URL + 'combo.registration.process.php',
          data: 'act=getAccommodationDetails&hotel_id=' + hotel_id,
          async: false,
          dataType: 'html',
          success: function(JSONObject) {
            console.log(JSONObject);
            // $('#hotelPackageLists').html(JSONObject);
            $('#hotelPackageLists').fadeOut(300, function() {
              $(this).html(JSONObject).fadeIn(300);
            });
          }
        });
      }
