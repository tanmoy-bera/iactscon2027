        ...
        <div class="registration_right">
            ...
            <div class="registration_right_body">
              <div class="registration_right_body_head">
                <div class="registration_right_body_head_left">
                    <h4><?=$rowInfo['tariff_user_details_subtitle']?></h4>
                   <h5><?=$rowInfo['tariff_user_details_description	']?></h5>
                </div>
              </div>
          ...
          <fieldset class="registration_right_wrap category">
            ...
            <div class="registration_right_body">
              <div class="registration_right_body_head">
                <div class="registration_right_body_head_left">
                  <h4><?=$rowInfo['tariff_category_subtitle']?></h4>
                  <h5><?=$rowInfo['tariff_category_description']?></h5>
                </div>
              </div>
              <div class="registration_right_body_content">
          ...
          <fieldset class="registration_right_wrap accomodationFindset">
             <?
              ...
              <div class="registration_right_body">
                  <div class="registration_right_body_head">
                      <div class="registration_right_body_head_left">
                           <h4><?=$rowInfo['tariff_accommodation_subtitle']?></h4>
                           <h5><?=$rowInfo['tariff_accommodation_description']?></h5>
                      </div>
          ...
          <fieldset class="registration_right_wrap WorkshopFindset">
            ...
            <div class="registration_right_body">
              <div class="registration_right_body_head">
                <div class="registration_right_body_head_left">
                  <h4><?=$rowInfo['tariff_workshop_subtitle']?></h4>
                  <h5><?=$rowInfo['tariff_workshop_description']?></h5>
                </div>
                <div class="registration_right_body_head_right">
          ...
          ?>
            ...
            <fieldset class="registration_right_wrap dinnerFieldset">
              ...
              <div class="registration_right_body">
                <div class="registration_right_body_head">
                  <div class="registration_right_body_head_left">
                      <h4><?=$rowInfo['tariff_banquet_subtitle']?></h4>
                     <h5><?=$rowInfo['tariff_banquet_description']?></h5>
                  </div>
                </div>
                <div class="registration_right_body_content">
                  <div class="cus_check_wrap g2">
          ...
          <fieldset class="registration_right_wrap accompanyfieldset">
            ...
            <div class="registration_right_body">
              <div class="registration_right_body_head">
                <div class="registration_right_body_head_left">
                    <h4><?=$rowInfo['tariff_accompany_subtitle']?></h4>
                  <h5><?=$rowInfo['tariff_accompany_description']?></h5>
                </div>
              </div>
              <div class="registration_right_body_content">
          ...
          <fieldset class="registration_right_wrap">
            ...
            ?>
            <div class="registration_right_head">
              <?=$rowInfo['tariff_cart_title']?>
            </div>
            <div class="registration_right_body">
              <div class="registration_right_body_head">
                <div class="registration_right_body_head_left">
                   <h4><?=$rowInfo['tariff_cart_subtitle']?></h4>
                  <h5><?=$rowInfo['tariff_cart_description']?></h5>
              ...
              <div class="registration_right_body_content">
                ...
                <div class="review_wrap">
                  ...
                  <div class="review_right">
                     <div id="complimentaryMessage" style="display: none;">
                      <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 350px; padding: 40px 20px; text-align: center;">
                          <div style="width: 80px; height: 80px; border-radius: 50%; background: rgba(83, 200, 232, 0.1); border: 2px solid var(--sky); display: flex; align-items: center; justify-content: center; margin-bottom: 24px;">
                              <i class="fal fa-check" style="font-size: 36px; color: var(--sky);"></i>
                          </div>
                          <h4 style="color: var(--sky); margin-bottom: 12px; font-size: 20px; font-weight: 600;">Complimentary Registration</h4>
                          <p style="color: #aaa; max-width: 320px; line-height: 1.6; margin: 0;">No payment is required for your selection.</p>
                          <input type="radio" name="payment_mode" value="Complimentary" hidden>
                      </div>
                  </div>
