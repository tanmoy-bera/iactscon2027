                                        ...
                                        <div id="paymentDetailsSection" style="display: none;">
                                            <div class="paymnet-box" id="chq-dd" style="display:none;" use="offlinePaymentOption" for="Cheque<?= $section ?>" actAs='fieldContainer'>
                                                <div class="top-input">
                                                    ...
                                                    <!-- <input type="text" placeholder="Enter Chq/DD No."> -->
                                                    <input type="number" class="form-control" name="cheque_number" id="cheque_number" validate="Please enter cheque number" placeholder="Enter Chq/DD No." type="number" maxlength="6" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==6) return false;">
                                            ...
                                            <div class="paymnet-box" id="neft-upi" style="display:none;" use="offlinePaymentOption" for="Neft<?= $section ?>" actAs='fieldContainer'>
                                                ...
                                                <div class="input-box">
                                                    <label>Image</label>
                                                    <input type="file" name="neft_document" id="upi" accept="image/*,application/pdf" style="display:none" validate="Please upload a image">
                                                    <label for="upi" class="file-label">+</label>
                                                </div>
                                            ...
                                            <div class="paymnet-box" id="cash" style="display:none;" use="offlinePaymentOption" for="Cash<?= $section ?>" actAs='fieldContainer'>
                                                ...
                                                <div class="input-box">
                                                    <label>Image</label>
                                                    <input type="file" name="cash_document" id="cash1" accept="image/*,application/pdf" class="cash_document" style="display:none" validate="Please upload a image">
                                                    <label for="cash1" class="file-label">+</label>
                                                    <span class="cash_file_name" style="font-size: 14px;padding: 5px;"></span>
                                                </div>
                                            </div>
                                            <div class="paymnet-box" style="display:none;" use="offlinePaymentOption" for="Card<?= $section ?>" actAs='fieldContainer'>
                                                <input type="radio" name="card_mode" use="card_mode_select" value="Indian" checked style="visibility: hidden;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="payment-wrap" id="paymentOptions">
                                        ...
                                        <div id="paymentDetailsSection" style="display: none;">
                                            ...
                                            <div class="paymnet-box" id="neft-upi" style="display:none;" use="offlinePaymentOption" for="Neft<?= $section ?>" actAs='fieldContainer'>
                                                ...
                                                <div class="input-box">
                                                    <label>Image</label>
                                                    <input type="file" name="neft_document" id="neft_document" accept="image/*,application/pdf" style="display:none" validate="Please upload a image">
                                            ...
                                            <div class="paymnet-box" id="cash" style="display:none;" use="offlinePaymentOption" for="Cash<?= $section ?>" actAs='fieldContainer'>
                                                ...
                                                <div class="input-box">
                                                    <label>Image</label>
                                                    <input type="file" name="cash_document" id="cash_document" class="cash_document" accept="image/*,application/pdf" style="display:none" validate="Please upload a image">
                                    ...
                                    <div class="payment-wrap" id="paymentOptions">
                                        ...
                                        <div id="paymentDetailsSection" style="display: none;">
                                            ...
                                            <div class="paymnet-box" id="neft-upi" style="display:none;" use="offlinePaymentOption" for="Neft<?= $section ?>" actAs='fieldContainer'>
                                                ...
                                                <div class="input-box">
                                                    <label>Image</label>
                                                    <input type="file" name="neft_document" id="neft_document<?= $section ?>" accept="image/*,application/pdf" style="display:none" validate="Please upload a image">
                                                    <label for="neft_document<?= $section ?>" class="file-label">+</label>
                                                </div>
                                            ...
                                            <div class="paymnet-box" id="cash" style="display:none;" use="offlinePaymentOption" for="Cash<?= $section ?>" actAs='fieldContainer'>
                                                ...
                                                <div class="input-box">
                                                    <label>Image</label>
                                                    <input type="file" name="cash_document" id="cash5" class="cash_document" accept="image/*,application/pdf" style="display:none" validate="Please upload a image">
                                                    <label for="cash5" class="file-label">+</label>
                                                    <span class="cash_file_name" style="font-size: 14px;padding: 5px;"></span>
                                                </div>
                                            </div>
                                            <div class="paymnet-box" style="display:none;" use="offlinePaymentOption" for="Card<?= $section ?>" actAs='fieldContainer'>
                                ...
                                <div class="payment-wrap" id="paymentOptions">
                                    ...
                                    <div id="paymentDetailsSection" style="display: block;">
                                        ...
                                        <div class="paymnet-box" id="cash" style="display:none;" use="offlinePaymentOption" for="Cash<?= $section ?>" actAs='fieldContainer'>
                                            ...
                                            <div class="input-box">
                                                <label>Image</label>
                                                <input type="file" name="cash_document" id="cash6" class="cash_document" accept="image/*,application/pdf" style="display:none" validate="Please upload a image">
                                                <label for="cash6" class="file-label cash_document">+</label>
                                                <span class="cash_file_name" style="font-size: 14px;padding: 5px;"></span>
                                            </div>
                                        </div>
                                        <div class="paymnet-box" style="display:none;" use="offlinePaymentOption" for="Card<?= $section ?>" actAs='fieldContainer'>
