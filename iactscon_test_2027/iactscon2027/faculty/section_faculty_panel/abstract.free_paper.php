...
<?php
	...
	?>
		<form name="frmSearch" id="frmSearch" action="abstract.free_paper.process.php" method="post">
						...
						<table width="100%">
							...
							?>
									<tr class="tlisting" <?=$rowStyleDecission?>>
										...
										{
										?>
											<a href="abstract.free_paper.php?show=view&id=<?=$rowAbstractDetails['id'].$searchString?>">
	...
	?>
		...
		<form name="frmAbstractReview" id="frmAbstractReview" action="abstract.free_paper.process.php" method="post">
			...
			<table width="100%" class="tborder">
				...
				<tr>
					<td colspan="2" align="right">
						<a href="abstract.free_paper.php?<?=$searchString?>">Back To Abstract Listing</a>
					</td>
				</tr>
				<tr>
							...
							<tr>
								<td align="left">
									...
									<input type="button" name="bttnWindowView" id="bttnWindowView" value="Back" 
									 class="btn btn-medium btn-red" onclick="window.location.href='abstract.free_paper.php?<?=$searchString?>'" style=" margin:10px 10px 10px 0;" />
