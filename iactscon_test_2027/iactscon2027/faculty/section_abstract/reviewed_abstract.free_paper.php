...
<?php
	...
	?>
		<form name="frmSearch" id="frmSearch" action="reviewed_abstract.free_paper.process.php" method="post">
					...
					<td colspan="2" style="margin:0px; padding:0px;">
						...
						<div class="tsearch" style="display:block;">
							<table width="100%">
								<tr>
									...
									<td align="left">Abstract / Case Report Topic:</td>
									<td align="left">
						...
						<table width="100%">
							<tr class="theader">
								...
								<td width="150" align="center">Abstract / Case Report Topic</td>
								<td align="left">Abstract / Case Report Title</td>
							...
							{
								$searchCondition          .= " AND abstract_submition_code LIKE '%".addslashes(trim($_REQUEST['src_abstract_submission_code']))."%'";
							}
							if($_REQUEST['src_paper_presentation_category']!="")
							{
								$searchCondition          .= " AND abstract_child_type = '".addslashes(trim($_REQUEST['src_paper_presentation_category']))."'";
							}
							if($_REQUEST['src_abstract_topic_id']!="")
							{
								$searchCondition          .= " AND abstract_topic_id = '".addslashes(trim($_REQUEST['src_abstract_topic_id']))."'";
							}
			...
			<table width="100%" class="tborder">
				...
				<tr>
					<td colspan="2" align="right">
						<a href="reviewed_abstract.free_paper.php?<?=$searchString?>">Back To Abstract Listing</a>
					</td>
				</tr>
				<tr>
							...
							<tr>
								<td align="left">
									...
									<input type="button" name="bttnWindowView" id="bttnWindowView" value="<?=($rowAbstractDetails ['totalReviewAttemptCount']<2)?'Cancel':'Back'?>" 
									 class="btn btn-medium btn-red" onclick="window.location.href='reviewed_abstract.free_paper.php?<?=$searchString?>'" style=" margin:10px 10px 10px 0;" />
