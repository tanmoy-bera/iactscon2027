...
<?php
	...
	?>
		<form name="frmSearch" id="frmSearch" action="all_abstract.video_presentation.process.php" method="post">
						...
						<table width="100%">
							...
							?>
									<tr class="tlisting" <?=$rowStyleDecission?>>
										...
										{
										?>
											<a href="all_abstract.video_presentation.php?show=view&id=<?=$rowAbstractDetails['id'].$searchString?>">Review</a>
										<?php
										}
										else if($rowAbstractDetails['totalReviewAttemptCount']<2)
										{
										?>
											<a href="all_abstract.video_presentation.php?show=view&id=<?=$rowAbstractDetails['id'].$searchString?>">Update Review</a>
										<?php
										}
										else
										{
										?>
											<a href="all_abstract.video_presentation.php?show=view&id=<?=$rowAbstractDetails['id'].$searchString?>">View</a>
										<?php
										}
										?>
	...
	?>
		...
		<form name="frmAbstractReview" id="frmAbstractReview" action="all_abstract.video_presentation.process.php" method="post">
			...
			<table width="100%" class="tborder">
				...
				<tr>
					<td colspan="2" align="right">
						<a href="all_abstract.video_presentation.php?<?=$searchString?>">Back To Abstract Listing</a>
					</td>
				</tr>
				<tr>
							...
							<tr>
								<td align="left">
									...
									<input type="button" name="bttnWindowView" id="bttnWindowView" value="<?=($rowAbstractDetails['totalReviewAttemptCount']<2)?'Cancel':'Back'?>" 
									 class="btn btn-medium btn-red" onclick="window.location.href='all_abstract.video_presentation.php?<?=$searchString?>'" style=" margin:10px 10px 10px 0;" />
