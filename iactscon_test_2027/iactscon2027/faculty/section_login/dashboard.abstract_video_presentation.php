	                             ...
	                             FROM (
								  ...
								  LEFT OUTER JOIN (
											...
											WHERE abstractRequest.status = 'A' 
											  AND abstractRequest.abstract_parent_type = 'VIDEO_PRESENTATION'
								      ) mainTAB";
...
?>
	<html>
		<head>
			<title>:: Abstract :: Video Presentation</title>
		...
		<body style="background-color:#DEDEDC; margin: 0px; padding: 0px;">
			<div style="padding:20px 20px 0 20px;">
				<div style="color:#000000; font-size:14px;">
					<div style="font-size:24px; margin-bottom: 17px;">Video Presentation</div>
				...
				<div id="container" data-dimension="170" data-info="Video Presentation" data-width="16" data-percent="<?=$reviewPercentage?>" data-fgcolor="#000000" data-bgcolor="#CCCCC9" style="margin:0px auto;"></div>
				<script>
