...
<?php
	...
	?>
		<form name="frmSearch" id="frmSearch" action="abstract.video_presentation.process.php" method="post">
						...
						<table width="100%">
							...
							?>
									<tr class="tlisting" <?=$rowStyleDecission?>>
										...
										{
										?>
											<a href="abstract.video_presentation.php?show=view&id=<?=$rowAbstractDetails['id'].$searchString?>">
											<span title="Review" class="icon-pen" /></a>
										<?php
										}
										else
										{
										?>
											<a href="abstract.video_presentation.php?show=view&id=<?=$rowAbstractDetails['id'].$searchString?>">
											<span title="View Abstract" class="icon-eye" /></a>
										<?php
										}
										?>
	...
	?>
		...
		<form name="frmAbstractReview" id="frmAbstractReview" action="abstract.video_presentation.process.php" method="post">
			...
			<table width="100%" class="tborder">
				...
				<tr>
					<td colspan="2" align="right">
						<a href="abstract.video_presentation.php?<?=$searchString?>">Back To Abstract Listing</a>
					</td>
				</tr>
				<tr>
					...
					<td width="35%" style="margin:0px; padding:0px;" class="tborder" valign="top">
						...
						<table width="100%">
							<tr>
								<td align="left" class="thighlight">Review Panel</td>
							</tr>
						</table>
						...
						<table width="100%">
							<tr>
								<td align="left">
									...
									<input type="button" name="bttnWindowView" id="bttnWindowView" value="Back" 
									 class="btn btn-medium btn-red" onclick="window.location.href='abstract.video_presentation.php?<?=$searchString?>'" style=" margin:10px 10px 10px 0;" />
									...
									?>
										<input type="submit" name="submitWindowView" id="submitWindowView" class="btn btn-medium btn-blue"  
										 value="<?=($abstractResultSet['totalReviewAttemptCount']==0)?'Submit':'Update'?>" style=" margin:10px 10px 10px 0;" />
									<?php
									}
									?>
