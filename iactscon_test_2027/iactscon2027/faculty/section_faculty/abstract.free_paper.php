				...
				<tr>
					<td colspan="2" style="margin:0px; padding:0px;">
						...
						<table width="100%">
							...
							$searchCondition               = "";
							$searchCondition              .= " AND grandTAB.abstract_parent_type = 'FREE_PAPER_SESSION'";
							...
							$sqlAbstractDetails['QUERY']            = "
												SELECT abstractRequest.*,
													   ...
													   registeredDelegates.isAbstract,
													   ...
													   IFNULL(abstractReview.id, 0) AS abstractReviewId,
													   IFNULL(abstractReview.marks_obtained, 0) AS marks_obtained,
													   abstractReview.faculty_review,
													   
													   IFNULL(totalReviewAttempt.totalReviewAttemptCount, 0) AS totalReviewAttemptCount  
									   ...
									   LEFT OUTER JOIN (
															...
															SELECT user.*,
																   ...
																   registrationTariffCutoff.cutoff_title AS cutoffTitle,
																   registrationTariffClassification.classification_title 
																	 
															  FROM "._DB_USER_REGISTRATION_." user 
																
												   LEFT OUTER JOIN "._DB_REGISTRATION_CLASSIFICATION_." AS registrationTariffClassification
																ON user.registration_tariff_id = registrationTariffClassification.id
																 
												   LEFT OUTER JOIN "._DB_TARIFF_CUTOFF_." AS registrationTariffCutoff
																ON user.registration_tariff_cutoff_id = registrationTariffCutoff.id 
									   ...
									   LEFT OUTER JOIN "._DB_ABSTRACT_REVIEW_RESULT_." abstractReview 
												   ...
												   AND abstractReview.faculty_id = '".$mycms->getLoggedUserId()."' 
