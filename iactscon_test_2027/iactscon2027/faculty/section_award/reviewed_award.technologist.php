...
<?php
	...
	?>
		<form name="frmSearch" id="frmSearch" action="reviewed_award.technologist.process.php" method="post">
						...
						<table width="100%">
							...
							?>
									<tr class="tlisting" <?=$rowStyleDecission?>>
										...
										{
										?>
											<a href="reviewed_award.technologist.php?show=view&id=<?=$rowAwardDetails['id'].$searchString?>">Review</a>
										<?php
										}
										else if($rowAwardDetails['totalReviewAttemptCount']<2)
										{
										?>
											<a href="reviewed_award.technologist.php?show=view&id=<?=$rowAwardDetails['id'].$searchString?>">Update Review</a>
										<?php
										}
										else
										{
										?>
											<a href="reviewed_award.technologist.php?show=view&id=<?=$rowAwardDetails['id'].$searchString?>">View</a>
										<?php
										}
										?>
	...
	?>
		...
		<form name="frmAwardReview" id="frmAwardReview" action="reviewed_award.technologist.process.php" method="post">
			...
			<table width="100%" class="tborder">
				...
				<tr>
					<td colspan="2" align="right">
						<a href="reviewed_award.technologist.php?<?=$searchString?>">Back To Award Listing</a>
					</td>
				</tr>
				<tr>
							...
							<tr>
								<td align="left">
									...
									<input type="button" name="bttnWindowView" id="bttnWindowView" value="<?=($rowAwardDetails['totalReviewAttemptCount']<2)?'Cancel':'Back'?>" 
									 class="btn btn-medium btn-red" onclick="window.location.href='reviewed_award.technologist.php?<?=$searchString?>'" style=" margin:10px 10px 10px 0;" />
