...
<?php
	...
	?>
		<form name="frmSearch" id="frmSearch" action="all_award.pg_student.process.php" method="post">
						...
						<table width="100%">
							...
							?>
									<tr class="tlisting" <?=$rowStyleDecission?>>
										...
										{
										?>
											<a href="all_award.pg_student.php?show=view&id=<?=$rowAwardDetails['id'].$searchString?>">Review</a>
										<?php
										}
										else if($rowAwardDetails['totalReviewAttemptCount']<2)
										{
										?>
											<a href="all_award.pg_student.php?show=view&id=<?=$rowAwardDetails['id'].$searchString?>">Update Review</a>
										<?php
										}
										else
										{
										?>
											<a href="all_award.pg_student.php?show=view&id=<?=$rowAwardDetails['id'].$searchString?>">View</a>
										<?php
										}
										?>
	...
	?>
		...
		<form name="frmAwardReview" id="frmAwardReview" action="all_award.pg_student.process.php" method="post">
			...
			<table width="100%" class="tborder">
				...
				<tr>
					<td colspan="2" align="right">
						<a href="all_award.pg_student.php?<?=$searchString?>">Back To Award Listing</a>
					</td>
				</tr>
				<tr>
							...
							<tr>
								<td align="left">
									...
									<input type="button" name="bttnWindowView" id="bttnWindowView" value="<?=($rowAwardDetails['totalReviewAttemptCount']<2)?'Cancel':'Back'?>" 
									 class="btn btn-medium btn-red" onclick="window.location.href='all_award.pg_student.php?<?=$searchString?>'" style=" margin:10px 10px 10px 0;" />
