...
<body class="single inner-page">
  ...
  $resultInfo      = $mycms->sql_select($sqlInfo);
  $rowInfo         = $resultInfo[0];
  $hod_consent_file_types = $rowInfo['hod_consent_file_types'];
            ...
            <div class="row">
              ...
              <div class="col-lg-6 carvslider-holder bdrRight">
                ...
                <div class="lftminhgt">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-12 form mb-3 ">
                            <div class="d-flex">
                              ...
                              <div class="col-lg-1">
                                <button type="button" class="pay-button" onclick="checkUserEmail(this)" value="Go" style="margin: 4px 5px;padding-left: 15px;">Go<span><i class="fas fa-arrow-right"></i></span></button>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-lg-12 form mb-3 <?= $blurclass ?>" id="membership_id" style="display:none">

                            <div class="d-flex">
                              <span><img src="images/address-R.png" alt=""></span>
                              <input type="text" clas="form-control <?= $disabledclass ?>" name="mamnership_id_prefix" style="pointer-events:none; width:10%" id="" value="L/A">
                              <input type="text" class="form-control <?= $disabledclass ?>" name="membership_number" id="membership_number" onkeypress="return isNumber(event)" value="<?= ($userRec['member_id'] != '') ? ($userRec['member_id']) : '' ?>" placeholder="Membership Id" autocomplete="off" <?= $disabled ?> validate="Please Enter Your Membership Id" autocomplete="nope">
                            </div>
                          </div>
                          <?php
                          if (in_array("Address", $available_registration_fields)) {
                          ...
                          if (in_array("Gender", $available_registration_fields)) {
                          ?>
                            <div style="padding-left: 0;" class="col-lg-6 mb-3 d-flex align-items-center <?= $blurclass ?>" id="radioGender">
                              <label>Gender: </label>
                          ...
                          ?>
                          <div class="auth-file-upload-wrap <?= $blurclass ?>" id="hod_consent_pgt" style="padding-top:2px; display: none">
                            <div>
                              <h6 style="margin: 0 0 2px;">HOD Consent</h6><?php $type = json_decode($hod_consent_file_types); ?>
                              <span> <?= ($type[0] != '') ? strtoupper($type[0]) . " | " : '' ?><?= ($type[1] != '') ? ucfirst($type[1]) : '' ?><?= ($type[2] != '') ? " | " . ucfirst($type[2]) : '' ?></span>
                            </div>
                            <div class="auth-file-upload" style="width:95px;border-left: 0px solid var(--white);">
                              ...
                              <div class="file-up-dtls">
                                ...
                                <input class="form-control  <?= $disabledclass ?>" type="file" id="formFileHod" name="upload_consent_abstract_file" <?= $disabled ?> required>
                      ...
                      <div class="next-prev-btn-box ">
                        ...
                        <a class="btn next-btn btn-w next <?php if (count($userRec) > 0) {
                                                            ...
                                                            echo 'disabled-click';
                                                                                                    ...
                                                                                                    echo 'block';
                                                                                                  } ?>" workshop-count="<?= count($workshopDetailsArray) ?>" accompany-count="<?= $accompanyCount ?>" banquet-count="<?= count($dinnerTariffArray) ?>" accommodation-count="<?= $countAcc ?>" title="<?= $cfg['WORKSHOP_TITLE'] ?>">Next
                        </a>
                      </div>
                    </div>
                  </div>
                    ...
                    ?>
                            ...
                            <div id="accompany-container">
                              ...
                              <div class="add-accompany">
                                ...
                                <div class="accompany-inner">
                                  <?php if (json_decode($row['inclusion_conference_kit_date']) != "" || json_decode($row['inclusion_lunch_date']) != "") { ?>
                                    <p>Inclusion</p>
                                    <div class="acc-name-wrap">
                                      <div class="acc-inclusion">
                                        <div class="acc-icons">
                                          ...
                                          <?php if (json_decode($row['inclusion_conference_kit_date']) != "") {
                                            // echo ($row['inclusion_conference_kit_date']); 
                                          ?>
                                            <img src="<?= _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE'] . $row['inclusion_conference_kit_icon'] ?>" alt="" class="acc-icons-tooltip" title="Conference Kit" />
                                          <?php } ?>
                                          <?php if (json_decode($row['inclusion_lunch_date']) != "") { ?>
                                            <img src="<?= _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE'] . $row['inclusion_lunch_icon'] ?>" alt="" class="acc-icons-tooltip" title="Lunch" />
                                          <?php } ?>
                      ...
                      <div class="bottom-fx">
                        ...
                        <div class="next-prev-btn-box">
                          ...
                          <a class="btn next-btn prev" title="<?= $cfg['WORKSHOP_TITLE'] ?>" workshop-count="<?= count($workshopDetailsArray) ?>">Prev</a>
                  ...
                  <div class="carv-total-holder section no-border" id="section6">
                    <?php
                              ...
                              <div class="carv-slide-info">
                                ...
                                <div class="carv-slide-info-ctn">
                                  ...
                                  <div class="btnholder d-flex">
                                    ...
                                    <a class="btn ml-10 next-btn prev" accompany-count="<?= $countAcc ?>" banquet-count="<?= count($dinnerTariffArray) ?>"><svg class="icon-color" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                        <path d="M34.5 239L228.9 44.7c9.4-9.4 24.6-9.4 33.9 0l22.7 22.7c9.4 9.4 9.4 24.5 0 33.9L131.5 256l154 154.8c9.3 9.4 9.3 24.5 0 33.9l-22.7 22.7c-9.4 9.4-24.6 9.4-33.9 0L34.5 273c-9.4-9.4-9.4-24.6 0-33.9z" />
                                      </svg></a>
          ...
          <div class="card-details" id="paymentOptions" style="filter: blur(1.6px);width: 40%;">
            <div class="card-details-inner">
              ...
              <div class="col-xs-12 form-group" style="display:none;" use="offlinePaymentOption" for="Card" actAs='fieldContainer'>
                <div class="checkbox custom-radio-holder">
                  ...
                  <!-- <div>
                    <label class="container-box custom-radio" style="float:left; margin-right:30px;">
                      <img src="<?= _BASE_URL_ ?>images/international_globe.png" height="20px;" width="20px">
                      International Card
                      <input type="radio" name="card_mode" use="card_mode_select" value="International">
                      <span class="checkmark"></span>
                    </label>
                    <label class="container-box custom-radio" style="float:left; margin-right:30px;">
                      <img src="<?= _BASE_URL_ ?>images/india_globe.png" height="20px;" width="20px">
                      Indian Card
                ...
                <!--  <div class="cardbox-holder" style="background:url(/isnezcon2024/images/upi-bg.png);">
                      
                         
                              <div class="form-group">
                                  <input type="number" maxlength="16" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==16) return false;" class="cardnumber form-control" placeholder="XXXX XXXX XXXX XXXX">
                              </div>
                      
                              <div class="cvv-thru d-flex">
                              <div class="d-flex">
                                  <label>CVV</label>
                              <div class="form-group">
                                  
                                  <input type="number" maxlength="4" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==4) return false;" class="form-control" placeholder="XX/XX">
                              </div>
                              </div>
                              <div class="d-flex">
                                  <label class="maxw">VALID THRU</label>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  <input type="text" class="form-control cardname" placeholder="CARDHOLDER NAME">
                              </div>
                        </div> -->
              ...
              <div class="card-form" id="paymentDetailsSection" style="display: none;">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12" style="display:none;" use="offlinePaymentOption" for="Cash" actAs='fieldContainer'>
                    ...
                    <? php/*?><input type="date" class="form-control" name="cash_deposit_date" id="cash_deposit_date" max="<?= $mycms->cDate("Y-m-d") ?>" min="<?= $mycms->cDate("Y-m-d", "-6 Months") ?>" validate="Please select date" placeholder="Date">
                    <?php*/ ?>
                  ...
                  WHERE `id`!='' AND `title`='QR Code'";
                  $result = $mycms->sql_select($sql_qr);
                  $QR_code = _BASE_URL_ . $cfg['EMAIL.HEADER.FOOTER.IMAGE'] . $result[0]['image'];
                  ?>
                    ...
                    <div class="neftbox upi-scanner-holder">
                      <div class="form-group">
                        <div class="datemmyy d-flex align-items-center">
                          ...
                          <div class="nefticon"><img src="<?= _BASE_URL_ ?>images/neftbg.png" alt=""></div>
                        </div>
                        <?php /*?>
            ...
            <div class="policy-div">
              <ul>
                <li><a href="<?= _BASE_URL_ ?>refund-policy.php">Cancellation Policy</a></li>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      // $('#registration_classification_id').on('click', function() {
      //   var reg_cls_id = $('#registration_classification_id').val();
      //   alert(reg_cls_id);
      // })
      ...
      function showSection(section) {
        ...
        if (section == 2) {
          var reg_cls_id = $('input[name="registration_classification_id[]"]:checked').val();
          if (reg_cls_id == 4) {
            $('#hod_consent_pgt').show();
          } else {
            $('#hod_consent_pgt').hide();
          }
          if (reg_cls_id == 1) {
            $('#membership_id').show();
            ...
            $('#membership_id').hide();
            $('#membership_number').val(0);
            $('input[name="membership_number"]').prop('disabled', true);
                      ...
                      $.ajax({
                        ...
                        success: function(returnMessage) {
                          ...
                          if (returnMessage == 'IN_USE') {
                            ...
                            $('#hod_consent_pgt').removeClass('blur_bw');
