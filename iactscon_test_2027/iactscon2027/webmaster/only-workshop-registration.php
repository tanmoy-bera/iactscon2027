    ...
    <div class="body_wrap">
        ...
        <div class="regi_search_wrap mb-3">
            ...
            <div class="regi_search_wrap_btn_box">
                ...
                <a href="javascript:void(null)" class="popup-btn add newregistartionbtn" data-tab="newregistartion"><?php add(); ?>New Reg</a>
            </div>
        </div>
        ...
        <div class="filter_wrap mb-3">
            ...
            <form name="frmSearch" method="post" action="only-workshop-registration.php" onSubmit="return FormValidator.validate(this);">
            ...
            <div class="spot_box">
                ...
                <div class="spot_box_bottom accm_bottom  justify-content-end">
                    ...
                    <div class="spot_box_bottom_right">
                      ...
                      <a href="javascript:void(0);" class="icon_hover badge_danger action-transparent delet" onclick="if (confirm('Do you really want to remove this user?')) { window.location.href='<?= $cfg['SECTION_BASE_URL'] ?>registration.process.php?act=Trash&id=<?= $idRow['delegate_id']; ?>&userType=WORKSHOP'; }"><?php delete(); ?>Delete</a>
                            ...
                            if ($resultFetchInvoice) {
                                    foreach ($resultFetchInvoice as $key => $rowFetchInvoice) {
                                        ...
                                        <?php
                                            ...
                                            $payment_status = ' <span class="mi-1 badge_padding badge_success w-max-con text-uppercase"><i class="far fa-check-circle"></i>Paid</span>';
                                        } else if ($rowFetchInvoice['payment_status'] == "UNPAID") {
                                            $hasUnpaidBill	 = true;
                                            $totalUnpaid 	+= $totalAmount;
                                            $payment_status= '<span class="mi-1 badge_padding badge_danger w-max-con text-uppercase"><i class="fal fa-times-circle"></i>Unpaid</span>';
                                        ?>
                                        <?php
                                        }
...
////////////
$(document).on('click', '.newregistartionbtn', function() {
  
     $('#workshopToggle').prop('checked', true);
    
    $('#workshopToggle').trigger('change');

    // Trigger the popup-btn functionality
    $('#newregistartion').fadeIn(); // or your popup open function
});
    //////////
</script>
</html>