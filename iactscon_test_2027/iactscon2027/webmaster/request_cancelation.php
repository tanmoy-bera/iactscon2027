    ...
    <div class="body_wrap">
        ...
        <div class="filter_wrap mb-3">
            <h4 class="filter_heading"><span>Advanced Filtering</span><a class="close_filter" onclick="$('.filter_wrap').slideUp();"><?php close(); ?></a></h4>
             <form name="frmSearch" method="post" action="request_cancelation.php" onSubmit="return FormValidator.validate(this);">
        ...
        <div class="spot_listing">
            <?php
                ...
                {
                    // $searchCondition  .= " AND slip.payment_mode = '".$_REQUEST['src_payment_mode']."'";
            ...
            <div class="spot_box">
                ...
                <div class="spot_box_bottom accm_bottom" >
                    ...
                    <div class="spot_box_bottom_right ">
                        <a  href="javascript:void(0);" class="icon_hover badge_danger action-transparent" onclick="if (confirm('Do you really want to cancel this invoice?')) { 
                                                                            window.location.href='registration.process.php?act=cancel_invoice_only&user_id=<?= $invoiceDetails['delegate_id'] ?>&invoice_id=<?= $invoiceDetails['invoiceId'] ?>&curntUserId=<?= $invoiceDetails['delegate_id']?>'; 
                                                                        }">
																	Cancel Invoice</a>
