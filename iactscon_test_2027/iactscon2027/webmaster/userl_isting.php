    ...
    <div class="body_wrap">
        ...
        <div class="regi_search_wrap mb-3">
            ...
            <div class="regi_search_wrap_btn_box">
                ...
                <a href="javascript:void(null)" class="popup-btn add" data-tab="newuser"><?php add(); ?>New User</a>
            </div>
        </div>
                        ...
                        <td class="action">
                            <div class="action_div dropdown" role="menu" aria-label="Actions for ${item.name}">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="javascript:void(null)" class="icon_hover badge_primary action-transparent"><?php printi(); ?>Print ID Card</a>
                                    <a href="javascript:void(null)" data-tab="edituser" class="popup-btn icon_hover badge_secondary action-transparent"><?php edit(); ?>Edit Details</a>
