...
<body>
    ...
    <div class="body_wrap">
            ...
            <div class="page_top_wrap_left">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Accommodation Report</li>
                    </ol>
                </nav>
                <h2>Spot Accommodation Report</h2>
                <h6>Daily breakdown of accommodations by payment mode.</h6>
            </div>
        </div>
        ...
        <div class="table_wrap">
            <h><?php circle(); ?>Summary of all Accommodation registration on the following days.</h>
            <table>
                <thead>
                    <tr>
                ...
                <thead>
                    <tr>
                        <th class="text-right text-muted border-0" colspan="10">Total Accommodation</th>
