...
<body>
    ...
    <div class="body_wrap">
            ...
            <div class="page_top_wrap_left">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Accompany Report</li>
                    </ol>
                </nav>
                <h2>Spot Accompany Report</h2>
                <h6>Daily breakdown of accompanies by payment mode.</h6>
            </div>
        </div>
        ...
        <div class="table_wrap">
            <h><?php circle(); ?>Summary of all Accompany registration on the following days.</h>
            <table>
                <thead>
                    <tr>
                ...
                <thead>
                    <tr>
                        <th class="text-right text-muted border-0" colspan="10">Total Accompany</th>
                        <th class="text-center border-0"><h6 class="text-center m-0 text_success">0</h6></th>
