...
switch ($action) {
	...
	case 'update':
		...
		$_SESSION['toaster'] = [
		   ...
		   echo '<script>window.location.href="system_master.php#accompany";</script>';
		break;
		/***************************************************************************/
...
function Inactive($mycms, $cfg)
{
	...
	$mycms->sql_update($sql);
      $_SESSION['toaster'] = [
		   ...
		   // pageRedirection(1, "hotel_listing.php", 1);
		   echo '<script>window.location.href="system_master.php#accompany";</script>';	exit();
	// break;
}
/*================ INACTIVE  =================*/
/*================ Remove  =================*/
function Remove($mycms, $cfg)
{
	...
	$mycms->sql_update($sql);
      $_SESSION['toaster'] = [
			'type' => 'success', // 'success' or 'error'
			'message' => 'Status deleted successfully!' // dynamic message
	    	];
