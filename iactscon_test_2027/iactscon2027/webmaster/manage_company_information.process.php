...
switch ($act) {
	...
	case 'edit_template_profile':
		...
		$sql['QUERY'] = "UPDATE " . _DB_COMPANY_INFORMATION_ . " 
									...
									`tariff_login_title`=?,
									`tariff_user_details_subtitle`=?,
									`tariff_user_details_description`=?,
									`tariff_category_subtitle`=?,
									`tariff_category_description`=?,
									`tariff_workshop_subtitle`=?,
									`tariff_workshop_description`=?,
									`tariff_accompany_subtitle`=?,
									`tariff_accompany_description`=?,
									`tariff_accommodation_subtitle`=?,
									`tariff_accommodation_description`=?,
									`tariff_banquet_subtitle`=?,
									`tariff_banquet_description`=?,
									`tariff_cart_subtitle`=?,
									`tariff_cart_description`=?
		...
		$sql['PARAM'][]		  =	array('FILD' => 'company_reply_email',    	 'DATA' => $_REQUEST['company_reply_email'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'scientific_reply_email',    	 'DATA' => $_REQUEST['scientific_reply_email'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'conf_start_date',    	 'DATA' => $_REQUEST['conf_start_date'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'conf_end_date',    	 'DATA' => $_REQUEST['conf_end_date'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'cgst_percentage',    	 'DATA' => $_REQUEST['cgst_percentage'], 		 'TYP' => 's');
		...
		$sql['PARAM'][]		  =	array('FILD' => 'header_text',    	 'DATA' => $_REQUEST['header_text'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'sub_header_text',    	 'DATA' => $_REQUEST['sub_header_text'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'color',    	 'DATA' => ltrim($_REQUEST['color'], '#'), 		 'TYP' => 's');
		...
		$sql['PARAM'][]		  =	array('FILD' => 'registration_disable',    	 'DATA' => $_REQUEST['registration_disable'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_login_title',    	 'DATA' => $_REQUEST['tariff_login_title'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_user_details_subtitle',    	 'DATA' => $_REQUEST['tariff_user_details_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_user_details_description',    	 'DATA' => $_REQUEST['tariff_user_details_description'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_category_subtitle',    	 'DATA' => $_REQUEST['tariff_category_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_category_description',    	 'DATA' => $_REQUEST['tariff_category_description'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_workshop_subtitle',    	 'DATA' => $_REQUEST['tariff_workshop_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_workshop_description',    	 'DATA' => $_REQUEST['tariff_workshop_description'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_accompany_subtitle',    	 'DATA' => $_REQUEST['tariff_accompany_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_accompany_description',    	 'DATA' => $_REQUEST['tariff_accompany_description'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_accommodation_subtitle',    	 'DATA' => $_REQUEST['tariff_accommodation_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_accommodation_description',    	 'DATA' => $_REQUEST['tariff_accommodation_description'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_banquet_subtitle',    	 'DATA' => $_REQUEST['tariff_banquet_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_banquet_description',    	 'DATA' => $_REQUEST['tariff_banquet_description'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_cart_subtitle',    	 'DATA' => $_REQUEST['tariff_cart_subtitle'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'tariff_cart_description',    	 'DATA' => $_REQUEST['tariff_cart_description'], 		 'TYP' => 's');
	...
	case 'edit_template_module':
		...
		$sql['PARAM'][]		  =	array('FILD' => 'abstract_header_text',    	 'DATA' => $_REQUEST['abstract_header_text'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'abstract_guideline_website',    	 'DATA' => $_REQUEST['abstract_guideline_website'], 		 'TYP' => 's');
        ...
        echo '<script>window.location.href="abstract_master.php#md";</script>';		exit();
		break;
	case 'edit_template_CMS':
		...
		$sql['PARAM'][]		  =	array('FILD' => 'acco_cancellation_info',    	 'DATA' => $_REQUEST['acco_cancellation_info'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'paymentGateway',    	 'DATA' => $_REQUEST['paymentGateway'], 		 'TYP' => 's');
		$sql['PARAM'][]		  =	array('FILD' => 'id',    	 'DATA' => $id, 		 'TYP' => 's');
     
		$mycms->sql_update($sql);


        echo '<script>window.location.href="company_info.php#cc";</script>';		
		exit();
	break;
