<?php
	...
	switch($action)
	{
		...
		case 'Active':
			...
			$sqlUpdateHotel['PARAM'][]	=	array('FILD' => 'status' , 	  'DATA' => 'A' ,             'TYP' => 's');
			$sqlUpdateHotel['PARAM'][]	=	array('FILD' => 'dinner_classification_id' ,  'DATA' => $dinner_id ,       	  'TYP' => 's');	
			$mycms->sql_update($sqlUpdateHotel);
	...
	case 'Inactive':
		...
		$dinner_id              		= addslashes(trim($_REQUEST['id']));
			...
			$sqlUpdateHotel['PARAM'][]	=	array('FILD' => 'status' , 	  'DATA' => 'I' ,             'TYP' => 's');
			$sqlUpdateHotel['PARAM'][]	=	array('FILD' => 'id' ,  'DATA' => $dinner_id ,       	  'TYP' => 's');	
			$mycms->sql_update($sqlUpdateHotel);
		...
		case'insert':
		   ...
		   // pageRedirection(1, "hotel_listing.php", 1);
		   echo '<script>window.location.href="system_master.php#dinner";</script>';			exit();
			break;
