    ...
    <div class="body_wrap">
        <div class="page_top_wrap mb-3">
            <div class="page_top_wrap_left">
                ...
                <h2>Spot Registration Report</h2>
                <h6>Daily breakdown of registrations by payment mode.</h6>
            </div>
        </div>
        ...
        <div class="table_wrap">
            <h><?php circle(); ?>Summary of all course registration on the following days</h>
            <table>
                <thead>
                    <tr>
                ...
                <thead>
                    <tr>
                        <th class="text-right text-muted border-0" colspan="10">Total Registered</th>
