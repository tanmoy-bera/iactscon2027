					...
					<form action="refund_process.php" onsubmit="return validateAmount();">
						...
						?>
							<table width="100%">
								...
								<tr>
									<td colspan="" align="left" width="20%">Refund Mode :</td>
									<td colspan="" align="left" width="20%"><?= $invoiceDetails['refund_payment_mode'] ?></td>
									<td colspan="" align="left" width="20%"> Date :</td>
									<td colspan="" align="left" width="20%"><?= $invoiceDetails['payment_date'] ?></td>
								...
								?>
									<tr>
										<td colspan="" align="left" width="20%">Number :</td>
										<td colspan="" align="left" width="20%"><?= $invoiceDetails['transection_number'] ?></td>
										<td colspan="" align="left" width="20%">Bank Name :</td>
										<td colspan="" align="left" width="20%"><?= $invoiceDetails['bank_name'] ?></td>
									</tr>
								<?
								}
								?>
						...
						<table width="100%" use="InvoiceTable">
							...
							?>
								...
								<tr class="tlisting">
									...
									<td align="right" valign="top">
										<textarea type="text" name="remarks[<?= $invoiceDetails['id'] ?>]" id="remarks" style="width:90%; text-transform:uppercase;" use='remarks' /></textarea>
									</td>
								</tr>
							<?
							}
						...
						<table width="100%">
							<tr>
								<td colspan="2" align="left">
									...
									<input type="Submit" name="bttnCotinue" id="bttnCotinue" value="Update" class="btn btn-midium btn-blue" style="float:left; margin-left:39%;" />
								</td>
							</tr>
						</table>
					</td>
						...
						<table width="100%">
							<tr>
								<td colspan="2" align="left">
									...
									<input type="Submit" name="bttnCotinue" id="bttnCotinue" value="Register" class="btn btn-midium btn-blue" style="float:left; margin-left:39%;" />
...
function conferenceRegistrationPaymentStatus($delegateId)
{
	...
	if ($rowInvoiceConferenceDtls['invoicePaymentStatus'] != "") {
		...
		if (in_array("UNPAID", $invoicePaymentStatusTemp)) {
			...
			in_array("COMPLIMENTARY", $invoicePaymentStatusTemp)
			...
			in_array("ZERO_VALUE", $invoicePaymentStatusTemp)
			&& !in_array("UNPAID", $invoicePaymentStatusTemp)
			&& !in_array("PAID", $invoicePaymentStatusTemp)
		) {
...
function registrationTarifTemplate($requestPage, $processPage, $registrationRequest = "GENERAL", $isComplementary = "", $isFaculty = "")
{
	...
	<form name="frmRegistrationStep1" id="frmRegistrationStep1" action="<?= $cfg['SECTION_BASE_URL'] . $processPage ?>" enctype="multipart/form-data" method="post" onsubmit="return backEndFromValidation();">
		...
		<table width="100%" align="center" class="tborder">
			...
			<tbody>
									...
									<table width="100%" use="registration_tariff">
										...
										?>
													<tr class="tlisting" <?= $styleCss ?>>
														<td align="left">
															<input type="checkbox" name="registration_classification_id[]" id="registration_classification_id" operationMode="registration_tariff" value="<?= $key ?>" currency="<?= $registrationDetailsVal[1]['CURRENCY'] ?>" />
						...
						<table width="100%">
							...
							<tr>
								...
								<td width="30%" align="left" valign="top">
									<input type="text" name="user_email_id" id="user_email_id" forType="emailValidate" use="add" style="width:90%;" value="<?= ($userRec['user_email_id'] != '') ? ($userRec['user_email_id']) : '' ?>" />
						...
						<table width="100%">
							...
							<tr>
								...
								<td align="left" width="30%">
									<input type="text" name="user_first_name" id="user_first_name" style="width:90%; text-transform:uppercase;" value="<?= ($userRec['user_first_name'] != '') ? ($userRec['user_first_name']) : '' ?>" />
								</td>
								<td width="20%" align="left">Address</td>
								<td width="30%" align="left" rowspan="3">
									<textarea name="user_address" id="user_address" style="height:75px; width:90%; text-transform:uppercase;"><?= ($userRec['user_address'] != '') ? ($userRec['user_address']) : '' ?></textarea>
								</td>
							</tr>
							<tr>
								<td align="left">Middle Name</td>
								<td align="left">
									<input type="text" name="user_middle_name" id="user_middle_name" style="width:90%; text-transform:uppercase;" value="<?= ($userRec['user_middle_name'] != '') ? ($userRec['user_middle_name']) : '' ?>" />
								</td>
								<td align="left"></td>
							</tr>
							<tr>
								...
								<td align="left">
									<input type="text" name="user_last_name" id="user_last_name" style="width:90%; text-transform:uppercase;" value="<?= ($userRec['user_last_name'] != '') ? ($userRec['user_last_name']) : '' ?>" />
								</td>
								<td align="left"></td>
							</tr>
							<tr>
								...
								<td align="left">
									<input type="radio" name="user_gender" id="user_gender_male" checked="checked" value="MALE" /> Male

									<input type="radio" name="user_gender" id="user_gender_female" value="FEMALE" /> Female
								</td>
								<td align="left">Country <span class="mandatory">*</span></td>
								<td align="left">
									<select name="user_country" id="user_country" style="width:90%;" forType="country" sequence="1">
							...
							<tr>
								...
								<td align="left">
									<input type="text" name="user_mobile_isd_code" id="user_mobile_isd_code" style="width:10%; text-transform:uppercase;" value="<?= ($userRec['user_mobile_isd_code'] != '') ? ($userRec['user_mobile_isd_code']) : '+91' ?>" maxlength="4" />

									<input type="text" name="user_mobile_no" id="user_mobile_no" forType="mobileValidate" style="width:75%; text-transform:uppercase;" value="<?= ($userRec['user_mobile_no'] != '') ? ($userRec['user_mobile_no']) : '' ?>" />
							...
							<tr>
								...
								<td align="left">
									<input type="text" name="user_postal_code" id="user_postal_code" style="width:90%; text-transform:uppercase;" value="<?= ($userRec['user_pincode'] != '') ? ($userRec['user_pincode']) : '' ?>" />
								</td>
								<td align="left">Enter City <span class="mandatory">*</span></td>
								<td align="left">
									<input type="text" name="user_city" id="user_city" style="width:90%; text-transform:uppercase;" value="<?= ($userRec['user_city_id'] != '') ? ($userRec['user_city_id']) : '' ?>" />
								</td>
							...
							<tr>
								...
								<td align="left" valign="top">
									<input type="checkbox" name="user_food_preference" id="user_food_preference_veg" groupName="user_food_choice" value="VEG" <?= ($userRec['user_food_preference'] == 'VEG') ? 'checked' : '' ?> /> Veg

									<input type="checkbox" name="user_food_preference" id="user_food_preference_non_veg" groupName="user_food_choice" value="NON_VEG" <?= ($userRec['user_food_preference'] == 'NON_VEG') ? 'checked' : '' ?> /> Non Veg
								</td>
								<td align="left" valign="top"></td>
								<td align="left" valign="top"></td>
							</tr>
				...
				<tr>
					<td width="20.5%"></td>
					<td align="right">
						<input type="submit" name="bttnSubmitStep1" id="bttnSubmitStep1" value="<?= ($isComplementary != 'Y') ? "Submit" : "Proceed" ?>" class="btn btn-large btn-blue" />
					</td>
				</tr>
				<tr>
		...
		<table width="100%" align="center" class="tborder">
			...
			<tbody>
					...
					<td colspan="2" style="margin:0px; padding:0px;">
						...
						<table width="100%">
							<tr>
								...
								<td width="80%" colspan="3" style="margin:0px; padding:0px;" class="tborder">
									<table width="100%">
										<tr>
											<td align="left" width="5%" valign="top"> <input name="dinner_value[]" id="dinner_value" value="" type="checkbox" style="width: 18px;height: 18px;" /></td>
											<td width="53%" align="left" valign="top"> BANQUET DINNER</td>
						...
						<table width="100%">
							...
							<tr>
								...
								<td width="30%" align="left" valign="top">
									<input type="text" name="user_email_id" id="user_email_id" forType="emailValidate" use="add" style="width:90%;" />
									<input type="hidden" name="email_id_validation" id="email_id_validation" />
						...
						<table width="100%">
							...
							<tr>
								...
								<td width="20%" align="left">Address</td>
								<td width="30%" align="left" rowspan="3">
									<textarea name="user_address" id="user_address" style="height:75px; width:90%; text-transform:uppercase;"></textarea>
								</td>
				...
				<tr>
					<td align="left" width="20%">First Name <span class="mandatory">*</span></td>
					<td align="left" width="30%">
						<input type="text" name="user_first_name" id="user_first_name" style="width:90%; text-transform:uppercase;" />
				...
				<tr>
					<td align="left">Middle Name</td>
					<td align="left">
						<input type="text" name="user_middle_name" id="user_middle_name" style="width:90%; text-transform:uppercase;" />
					</td>
					<td align="left"></td>
				</tr>
				<tr>
					<td align="left">Last Name <span class="mandatory">*</span></td>
					<td align="left">
						<input type="text" name="user_last_name" id="user_last_name" style="width:90%; text-transform:uppercase;" />
					</td>
					<td align="left">Country <span class="mandatory">*</span></td>
					<td align="left">
						<select name="user_country" id="user_country" style="width:90%;" forType="country" sequence="1">
				...
				<tr>
					<td align="left">Mobile <span class="mandatory">*</span></td>
					<td align="left">
						<input type="text" name="user_mobile_isd_code" id="user_mobile_isd_code" style="width:10%; text-transform:uppercase;" value="+91" maxlength="4" />

						<input type="text" name="user_mobile_no" id="user_mobile_no" forType="mobileValidate" style="width:75%; text-transform:uppercase;" />
					...
					<td align="left">Enter City <span class="mandatory">*</span></td>
					<td align="left">
						<input type="text" name="user_city" id="user_city" style="width:90%; text-transform:uppercase;" />
					</td>
				</tr>
				<tr>
					<td align="left">Postal Code <span class="mandatory">*</span></td>
					<td align="left">
						<input type="text" name="user_postal_code" id="user_postal_code" style="width:90%; text-transform:uppercase;" />
					</td>
		...
		<table width="100%" align="center" class="tborder">
			...
			<tbody>
					...
					<td colspan="2" style="margin:0px; padding:0px;">
									...
									<td width="80%" colspan="3" style="margin:0px; padding:0px;" class="tborder">
										<table width="100%" use="residential_tariff">
											...
											?>
													<tr class="tlisting" <?= $styleCss ?>>
														<td align="left">
															<input type="checkbox" name="registration_classification_id[]" id="registration_classification_id" operationMode="residential_tariff" value="<?= $key ?>" currency="<?= $registrationDetailsVal[1]['CURRENCY'] ?>" />
						...
						<table width="100%">
							...
							<tr>
								...
								<td align="left">Country <span class="mandatory"></span></td>
								<td align="left">
									<select name="user_country" id="user_country" style="width:90%;" forType="country" onchange="stateRetriver();" sequence="1">
										<option value="">-- Select Country --</option>
										<?php
										$sqlCountry['QUERY']    = "SELECT * FROM " . _DB_COMN_COUNTRY_ . " 
																	  WHERE `status` = 'A' 
							...
							<tr>
								<td align="left" valign="top">Food Preference</td>
								<td align="left" valign="top">
									<input type="checkbox" name="user_food_preference" id="user_food_preference_veg" groupName="user_food_choice" value="VEG" /> Veg

									<input type="checkbox" name="user_food_preference" id="user_food_preference_non_veg" groupName="user_food_choice" value="NON_VEG" /> Non Veg
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td width="20.5%"></td>
					<td align="right">
						<input type="submit" name="bttnSubmitStep1" id="bttnSubmitStep1" value="Submit" class="btn btn-large btn-blue" />
					</td>
				</tr>
				<tr>
					<td colspan="2" class="tfooter">&nbsp;</td>
						...
						<table width="100%">
							<div id="companion_display_div">
								...
								<table width="100%">
									<tr>
										<td align="right">
											<a onclick="addMoreAccompany('addMoreAccompany_placeholder_add','addMoreAccompany_template')" operationMode="addAccompanyButton">Add More Accompany</a>
										</td>
									</tr>
								</table>
								...
								<table width="100%">
									<tr>
										<td colspan="2" align="left">
											...
											<input type="submit" name="bttnSubmitStep1" id="bttnSubmitStep1" value="<?= ($isComplementary != 'Y') ? "Next Step" : "Proceed" ?>" class="btn btn-small btn-blue" style="float:right; margin-right:10%;" />

											<input type="button" name="bttnAdd" id="bttnAdd" value="Skip" class="btn btn-small btn-green" style=" float:right; margin-right:5%;" onclick="window.location.href = 'complimentary_registration.php?show=step4'" />
										</td>
									</tr>
								</table>
							</div>
								...
								<table width="100%">
									<tr>
										<td colspan="2" align="left">
											...
											<input type="button" name="bttnAdd" id="bttnAdd" value="Skip" class="btn btn-small btn-green" style=" float:right; margin-right:5%;" onclick="window.location.href = 'registration.php?show=notification'" />
										</td>
									</tr>
								</table>
							</div>
...
?>
	<form name="frmApplyForAccompany" method="post" action="registration.process.php" onSubmit="return accompanyFromValidatior(this);">
		...
		$currentCutoffId = getTariffCutoffId();
		$accompanyAmount = getCutoffTariffAmnt($currentCutoffId);
		?>

		<input type="hidden" name="accompanyTariffAmount" id="accompanyTariffAmount" value="<?= $accompanyAmount ?>" />
				...
				<td colspan="2" style="margin:0px; padding:0px;">
					...
					<table width="100%">
						...
						<tr>
							...
							<td align="left" style="width:30%;">
								<select style="width:90%;" name="registration_acc_cutoff" id="registration_acc_cutoff" onchange="setAccompanyTariff(event)">
									<option value="">-- Choose Cutoff --</option>
									<?php
									...
									if ($resultCutoff) {
										...
										foreach ($resultCutoff as $keyCutoff => $rowCutoff) {
									?>
											<option value="<?= $rowCutoff['id'] ?>" <?php if ($currentCutoffId == $rowCutoff['id']) {
																						echo 'selected';
																					} ?>><?= $rowCutoff['cutoff_title'] ?></option>
									<?php
										}
										//}
									}
					...
					<table width="100%">
						<div id="companion_display_div">
							...
							<table width="100%" style=" <?= ($accompanyCounter >= 3) ? "display:none;" : "" ?>">
								<tr>
									<td align="left">
										<a onclick="addMoreAccompany('addMoreAccompany_placeholder_add','addMoreAccompany_template',<?= $accompanyCounter ?>)" operationMode="addAccompanyButton">Add More Accompany</a>
									</td>
								</tr>
							</table>
							<?php
							setPaymentTermsRecord("add", "accompany");
							?>
							<table width="100%">
								<tr>
									<td align="left" width="20%">
					...
					<table width="100%">
						<div id="companion_display_div">
							...
							<table width="100%">
								<tr>
									<td align="left">
										<a onclick="addMoreAccompany('addMoreAccompany_placeholder_add','addMoreAccompany_template',<?= $accompanyCounter ?>)" operationMode="addAccompanyButton">Add More Guest</a>
									</td>
								</tr>
							</table>
							<?php
			...
			<table width="100%">
				...
				<tr>
					...
					<td width="30%" align="left">
						...
						<input type="text" name="accompany_name_<?= $formType ?>[#COUNTER]" id="accompany_name_<?= $formType ?>_#COUNTER" style="width:90%; text-transform:uppercase;" operationMode="accompany_name" required />
					</td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td align="left" valign="top">Food Preference</td>
					<td align="left" valign="top">
						<input type="radio" name="accompany_food_choice[#COUNTER]" id="accompany_food_preference_<?= $formType ?>_#COUNTER" value="VEG" checked="checked" /> Veg

						<input type="radio" name="accompany_food_choice[#COUNTER]" id="accompany_food_preference_<?= $formType ?>_#COUNTER" value="NON VEG" /> Non Veg
					</td>
				</tr>
				<? /*
                    <tr>
						...
						<table width="100%">
							<table width="100%">
								...
								<tr>
									...
									<td align="left" valign="top">
										<select name="accommodation_roomType_id" id="accommodation_roomType_id" class="drpdwn" style="width:90%;">
											<option value="">-- Select --</option>
							...
							<table width="100%">
								<tr>
									<td colspan="2" align="left">
										...
										<input type="button" name="bttnAdd" id="bttnAdd" value="Skip" class="btn btn-small btn-green" style=" float:right; margin-right:5%;" onclick="window.location.href = 'registration.process.php?act=step6'" />
									</td>
								</tr>
							</table>
						</table>
							...
							<table width="100%">
								<tr>
									<td colspan="2" align="left">
										...
										<input type="button" name="bttnAdd" id="bttnAdd" value="Skip" class="btn btn-small btn-green" style=" float:right; margin-right:5%;" onclick="window.location.href = 'registration.process.php?act=step6_abstractRegistration&abstractDelegateId=<?= $_REQUEST['abstractDelegateId'] ?>&userREGtype=<?= $_REQUEST['userREGtype'] ?>'" />
									</td>
								</tr>
							</table>
						</table>
							...
							<table width="100%">
								<tr>
									<td colspan="2" align="left">
										...
										<input type="button" name="bttnAdd" id="bttnAdd" value="Skip" class="btn btn-small btn-green" style=" float:right; margin-right:5%;" onclick="window.location.href = 'complimentary_general_registration_registration.process.php?act=step6'" />
									</td>
								</tr>
							</table>
						</table>
									...
									<tr class="tlisting">
										...
										?>
											<td align="right">
												...
												<input type="hidden" operationMode="tour_tariff_details" packageId="<?= $key ?>" cutoffId="<?= $keyCutoff ?>" currency="<?= getCurrency($delagateCatagory) ?>" value="<?= $cutoffvalue[getCurrency($delagateCatagory)] ?>" />
											</td>
										<?
										}
										?>
						...
						<table width="100%">
							<tr>
								<td colspan="2" align="left">
									...
									<input type="button" name="bttnAdd" id="bttnAdd" value="Skip" class="btn btn-small btn-green" style="float:right; margin-right:5%;" onclick="window.location.href = 'registration.php?show=step6'" />
								</td>
							</tr>
						</table>
						...
						<table width="100%">
							<tr>
								<td colspan="2" align="left">
									...
									<input type="Submit" name="bttnCotinue" id="bttnCotinue" value="Proceed" class="btn btn-midium btn-blue" style="float:right; margin-right:10%;" />
						...
						<table width="100%">
							...
							?>
								<tr>
									...
									<td align="left" valign="top">
										<font style=" color:#FF0000;margin-left: -87px;;">Please check here if you want to complete the payment process.</font>
									</td>
								</tr>
							<?
							}
							...
							<tr>
								<td colspan="2" align="left">
									...
									<input type="Submit" name="bttnCotinue" id="bttnCotinue" value="SUBMIT" class="btn btn-midium btn-blue" style="float:left; margin-left:39%;" />
...
?>
	...
	<table width="100%">
		...
		<tr>
			...
			<td width="30%" align="left">
				<select name="payment_mode" id="payment_mode" style="width:95%;" onchange="paymentModeRetriver(this.value)" use="payment_mode">
				...
				<div id="cashPaymentDiv">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="text" name="cash_deposit_date" id="cash_deposit_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use="cash_deposit_date" />
							</td>
							<td width="20%" align="left"></td>
							<td width="30%" align="left"></td>
						</tr>
				...
				<div id="chequePaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="text" name="cheque_number" id="cheque_number" style="width:90%; text-transform:uppercase;" use="cheque_number" />
							</td>
							<td width="20%" align="left">Drawee Bank</td>
							<td width="30%" align="left">
								<input type="text" name="cheque_drawn_bank" id="cheque_drawn_bank" style="width:90%; text-transform:uppercase;" use='cheque_drawn_bank' />
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">Cheque Date</td>
							<td width="30%" align="left">
								<input type="text" name="cheque_date" id="cheque_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use='cheque_date' />
							</td>
							<td width="20%" align="left"></td>
							<td width="30%" align="left"></td>
						</tr>
				...
				<div id="draftPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="text" name="draft_number" id="draft_number" style="width:90%; text-transform:uppercase;" use='draft_number' />
							</td>
							<td width="20%" align="left">Drawee Bank</td>
							<td width="30%" align="left">
								<input type="text" name="draft_drawn_bank" id="draft_drawn_bank" style="width:90%; text-transform:uppercase;" use="draft_drawn_bank" />
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">Draft Date</td>
							<td width="30%" align="left">
								<input type="text" name="draft_date" id="draft_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use='draft_date' />
							</td>
							<td width="20%" align="left"></td>
							<td width="30%" align="left"></td>
						</tr>
				...
				<div id="neftPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							<td width="20%" align="left">Drawee Bank</td>
							<td width="30%" align="left">
								<input type="text" name="neft_bank_name" id="neft_bank_name" style="width:90%; text-transform:uppercase;" use='neft_bank_name' />
							</td>
							<td align="left">Transaction Id</td>
							<td align="left">
								<input type="text" name="neft_transaction_no" id="neft_transaction_no" style="width:90%; text-transform:uppercase;" use='neft_transaction_no' />
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">Date</td>
							<td width="30%" align="left">
								<input type="text" name="neft_date" id="neft_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use='neft_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
				...
				<div id="cardPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="number" name="card_number" id="card_number" style="width:90%; text-transform:uppercase;" use='card_number' />
							</td>
							<td align="left">Remarks</td>
							<td align="left">
								<input type="text" name="remarks" id="remarks" style="width:90%; text-transform:uppercase;" use='remarks' />
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">Date</td>
							<td width="30%" align="left">
								<input type="text" name="card_date" id="card_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use='card_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
				...
				<div id="rtgsPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							<td width="20%" align="left">Drawee Bank</td>
							<td width="30%" align="left">
								<input type="text" name="rtgs_bank_name" id="rtgs_bank_name" style="width:90%; text-transform:uppercase;" use='rtgs_bank_name' />
							</td>
							<td align="left">Transaction Id</td>
							<td align="left">
								<input type="text" name="rtgs_transaction_no" id="rtgs_transaction_no" style="width:90%; text-transform:uppercase;" use='rtgs_transaction_no' />
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">Date</td>
							<td width="30%" align="left">
								<input type="text" name="rtgs_date" id="rtgs_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use='rtgs_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
				...
				<div id="cashPaymentDiv">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="date" name="cash_deposit_date" id="cash_deposit_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use="cash_deposit_date" />
							</td>
							<td width="20%" align="left"></td>
							<td width="30%" align="left"></td>
						</tr>
				...
				<div id="chequePaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="number" name="cheque_number" id="cheque_number" style="width:90%; text-transform:uppercase;" use="cheque_number" />
							</td>
						...
						<tr>
							...
							<td width="30%" align="left">
								<input type="date" name="cheque_date" id="cheque_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use='cheque_date' />
							</td>
							<td width="20%" align="left"></td>
							<td width="30%" align="left"></td>
						</tr>
				...
				<div id="draftPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						...
						<tr>
							...
							<td width="30%" align="left">
								<input type="date" name="draft_date" id="draft_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use='draft_date' />
							</td>
							<td width="20%" align="left"></td>
							<td width="30%" align="left"></td>
						</tr>
				...
				<div id="neftPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						...
						<tr>
							...
							<td width="30%" align="left">
								<input type="date" name="neft_date" id="neft_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use='neft_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
				...
				<div id="rtgsPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						...
						<tr>
							<td width="20%" align="left">Date <span class="mandatory">*</span></td>
							<td width="30%" align="left">
								<input type="date" name="rtgs_date" id="rtgs_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use='rtgs_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
				...
				<div id="cardPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						...
						<tr>
							<td width="20%" align="left">Date <span class="mandatory">*</span></td>
							<td width="30%" align="left">
								<input type="date" name="card_date" id="card_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use='card_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
				...
				<div id="creditPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							...
							<td width="30%" align="left">
								<input type="date" name="credit_date" id="credit_date" style="width:90%; text-transform:uppercase;" value="<?= date('Y-m-d') ?>" use='credit_date' />
							</td>
							<td align="left" rowspan="2">
								<div id="exhibitorTotalRemainBal" style="border:thin solid #FF0000; color:#FF0000; text-align:center; height:50px; width:100%;"></div>
							</td>
						</tr>
				...
				<div id="cardPaymentDiv" style="display:none;">
					<table width="100%" class="noborder">
						<tr>
							<td width="20%" align="left">Card Number</td>
							<td width="30%" align="left">
								<input type="number" name="number" id="card_number" style="width:90%; text-transform:uppercase;" use='card_number' />
							</td>
							<td align="left">Remarks</td>
							<td align="left">
								<input type="text" name="remarks" id="remarks" style="width:90%; text-transform:uppercase;" use='remarks' />
						...
						<tr>
							<td width="20%" align="left">Date</td>
							<td width="30%" align="left">
								<input type="text" name="card_date" id="card_date" style="width:90%; text-transform:uppercase;" rel="tcal" value="<?= date('Y-m-d') ?>" use='rtgs_date' />
							</td>
							<td align="left"></td>
							<td align="left"></td>
						</tr>
					...
					<td colspan="2" style="margin:0px; padding:0px;">
						...
						<table width="100%">
							...
							<?php if ($rowFetchUser['membership_number'] != '' && $rowFetchUser['membership_number'] !=0) { ?>
								<tr>
									<td align="left">Membership Id:</td>
									<td align="left"><?= "L/A-" . $rowFetchUser['membership_number'] ?></td>

								</tr>
							<?php } ?>
							<?php if ($rowFetchUser['user_document'] != '' && $rowFetchUser['user_document'] != null) { ?>
							<tr>
								<td align="left">HOD Censent:</td>
								<td align="left">
									<a href="<?= _BASE_URL_ . $cfg['FILES.ABSTRACT.REQUEST'] . $rowFetchUser['user_document'] ?>" target="blank">View</a>&nbsp;|&nbsp;
									<a href="<?= _BASE_URL_ . $cfg['FILES.ABSTRACT.REQUEST'] . $rowFetchUser['user_document'] ?>" target="blank" download>Download</a>
								</td>
...
function setPaymentTermsRecord($formType, $type = "")
{
	global $cfg, $mycms;
	$delegateId 	=  $_REQUEST['id'];
	$delagateCatagory = getUserClassificationId($delegateId);
	...
	<table width="100%">
		...
		<tr>
			...
			<td align="left">
				...
				?>
				<input type="radio" name="registration_type_add" id="registration_type_general_add" value="GENERAL" operationMode="registration_type" checked="checked" onclick="calculateAccompanyAmount();" <?= $radioDisable ?> /> General

				&nbsp;
				<input type="radio" name="registration_type_add" id="registration_type_complementary_add" value="ZERO_VALUE" operationMode="registration_type" <?= $radioSelect ?> />ZERO VALUE
			</td>
		</tr>
	</table>
