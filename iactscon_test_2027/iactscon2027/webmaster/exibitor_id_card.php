            ...
            <div class="page_top_wrap_left">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Exibitor ID Card</li>
                    </ol>
                </nav>
                <h2>Exibitor ID Card</h2>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div>
                                <div class="regi_name">Company Name</div>
                                <div class="regi_contact">
                                    <span>
                                        <?php qr() ?>Exhibitor Code
                                    </span>
                                    <span>
                                        <?php call(); ?>9674833617
                                    </span>
