    ...
    <div class="body_wrap">
        <div class="page_top_wrap mb-3">
            <div class="page_top_wrap_left">
                ...
                <h2>State Listing</h2>
                <h6>Manage state name, and status.</h6>
            </div>
        </div>
        <div class="regi_search_wrap mb-3">
            <div class="regi_search">
                <?php search(); ?>
                <input placeholder="Search by State, Country, or Status...">
            </div>
            <div class="regi_search_wrap_btn_box">
                <a href="javascript:void(null)" class="popup-btn add" data-tab="newstate"><?php add(); ?>New State</a>
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="action">
                            <div class="action_div">
                                <a class="popup-btn icon_hover badge_secondary action-transparent br-5 w-auto" data-tab="editstate"><?php edit(); ?></a>
