            ...
            <div class="com_info_right">
                ...
                <div class="com_info_box" id="registration">
                    <div class="com_info_box_grid">
                        <div class="com_info_box_grid_box">
                            ...
                            <div class="com_info_box_inner">
                                <h4 class="com_info_box_inner_sub_head"><span>Manage Classification</span><a class="add mi-1 popup-btn" data-tab="newregistrationclassification"><?php add() ?>Add Classification</a></h4>
                                <div class="table_wrap">
                                    <table>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if (!empty($rowsl['icon'])) { ?><img src="<?php echo $icon_image; ?>" width="10%" height="10%"> <?php } ?></td>
                                                <td>
                                                    <div class="action_div">
                                                        <?php	
                                                        if($rowsl['status']=='A'){
                ...
                <div class="com_info_box" id="workshop">
                    ...
                    <div class="com_info_box_grid">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="action">
                                                    <div class="action_div">
                                                        <a href="#" class="icon_hover badge_secondary action-transparent br-5 w-auto popup-btn" data-tab="editaccompany"><?php edit(); ?></a>
                                                        <a href="#" class="icon_hover badge_danger action-transparent br-5 w-auto"><?php delete(); ?></a>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="com_info_box_grid_box">
                            <h5 class="com_info_box_head">
                                <n><span class="text_danger"><?php suitcase() ?></span> Accompany Tariff</n>
                            </h5>
                            <div class="com_info_box_inner">
                                <h4 class="com_info_box_inner_sub_head"><span>Manage Accompany Tariff</span></h4>
                                <div class="table_wrap">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th class="sl" rowspan="2">#</th>
                                                <th rowspan="2">Accompany Classification</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="action">
                                                    <div class="action_div">
                                                        <a href="#" class="icon_hover badge_secondary action-transparent br-5 w-auto popup-btn" data-tab="accompanytariff"><i class="fal fa-pencil"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span><?=$rowFetchDinner['dinner_classification_name']?></span>
                                                    <div class="regi_contact">
                                                        <span>
                                                            <i class="fal fa-globe"></i><?=$rowFetchDinner['link']?>
                                                        </span>
                                                    </div>
                                                </td>
...
//////////////////registration classification edit///////////////
     $(document).on('click', '.editRegisclassificationBtn', function() {
      ...
      ///////////////////registration classification edit end///////////////////////////
</script>
