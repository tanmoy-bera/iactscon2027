...
<script>
    ...
    $(window).scroll(function() {
     ...
     $('.hotel_check').click(function() {
      ...
      $('.slide_left_menu').click(function() {
        $(".dash_lt").toggleClass("active");
        $('header').toggleClass("side_menu_open");
        $('.body_wrap').toggleClass("side_menu_open");
        $('.left_menu_overlay').toggleClass("active");
    });
    $('.left_menu_overlay').click(function() {
        $(".dash_lt").removeClass("active");
        $('header').removeClass("side_menu_open");
        $('.body_wrap').removeClass("side_menu_open");
        $('.left_menu_overlay').removeClass("active");
    });
</script>